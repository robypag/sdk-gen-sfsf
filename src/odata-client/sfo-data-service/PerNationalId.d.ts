...
export declare namespace PerNationalId {
     ...
     * Use to reference this property in query operations such as 'select' in the fluent request API.
     */
    const COUNTRY_NAV: OneToOneLink<PerNationalId, Territory>;
    /**
     ...
     */
    const _allFields: Array<StringField<PerNationalId> | DateField<PerNationalId> | BooleanField<PerNationalId> | OneToOneLink<PerNationalId, Territory> | OneToOneLink<PerNationalId, PerPerson>>;
    /**
     * All fields selector.
     */
