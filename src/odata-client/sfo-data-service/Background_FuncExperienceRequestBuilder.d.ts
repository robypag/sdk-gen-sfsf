 ...
 */
export declare class Background_FuncExperienceRequestBuilder extends RequestBuilder<Background_FuncExperience> {
    /**
...
//# sourceMappingURL=Background_FuncExperienceRequestBuilder.d.ts.map