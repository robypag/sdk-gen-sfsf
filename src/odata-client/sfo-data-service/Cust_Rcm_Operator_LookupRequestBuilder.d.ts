 ...
 */
export declare class Cust_Rcm_Operator_LookupRequestBuilder extends RequestBuilder<Cust_Rcm_Operator_Lookup> {
    /**
...
//# sourceMappingURL=Cust_Rcm_Operator_LookupRequestBuilder.d.ts.map