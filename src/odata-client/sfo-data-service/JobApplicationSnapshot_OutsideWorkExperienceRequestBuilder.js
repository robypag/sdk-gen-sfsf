...
var JobApplicationSnapshot_OutsideWorkExperienceRequestBuilder = /** @class */ (function (_super) {
    ...
    JobApplicationSnapshot_OutsideWorkExperienceRequestBuilder.prototype.getByKey = function (backgroundElementId) {
        return new core_1.GetByKeyRequestBuilder(JobApplicationSnapshot_OutsideWorkExperience_1.JobApplicationSnapshot_OutsideWorkExperience, { backgroundElementId: backgroundElementId });
    };
    /**
    ...
    JobApplicationSnapshot_OutsideWorkExperienceRequestBuilder.prototype.getAll = function () {
        return new core_1.GetAllRequestBuilder(JobApplicationSnapshot_OutsideWorkExperience_1.JobApplicationSnapshot_OutsideWorkExperience);
    };
