 ...
 */
export declare class CandidateCommentsRequestBuilder extends RequestBuilder<CandidateComments> {
    /**
...
//# sourceMappingURL=CandidateCommentsRequestBuilder.d.ts.map