...
var EmployeeTimePol = /** @class */ (function (_super) {
     ...
     */
    EmployeeTimePol._defaultServicePath = 'VALUE_IS_UNDEFINED';
...
(function (EmployeeTimePol) {
     ...
     * Use to reference this property in query operations such as 'select' in the fluent request API.
     */
    EmployeeTimePol.CREATED_BY_NAV = new core_1.OneToOneLink('createdByNav', EmployeeTimePol, User_1.User);
    /**
     * Static representation of the one-to-one navigation property [[lastModifiedByNav]] for query construction.
     * Use to reference this property in query operations such as 'select' in the fluent request API.
     */
    EmployeeTimePol.LAST_MODIFIED_BY_NAV = new core_1.OneToOneLink('lastModifiedByNav', EmployeeTimePol, User_1.User);
    /**
     * Static representation of the one-to-one navigation property [[mdfSystemRecordStatusNav]] for query construction.
     * Use to reference this property in query operations such as 'select' in the fluent request API.
     */
    EmployeeTimePol.MDF_SYSTEM_RECORD_STATUS_NAV = new core_1.OneToOneLink('mdfSystemRecordStatusNav', EmployeeTimePol, MdfEnumValue_1.MdfEnumValue);
    /**
