...
export namespace EmpJobRelationships {
   ...
   * Use to reference this property in query operations such as 'select' in the fluent request API.
   */
  export const REL_USER_NAV: OneToOneLink<EmpJobRelationships, User> = new OneToOneLink('relUserNav', EmpJobRelationships, User);
  /**
   * Static representation of the one-to-one navigation property [[relationshipTypeNav]] for query construction.
   * Use to reference this property in query operations such as 'select' in the fluent request API.
   */
  export const RELATIONSHIP_TYPE_NAV: OneToOneLink<EmpJobRelationships, PicklistOption> = new OneToOneLink('relationshipTypeNav', EmpJobRelationships, PicklistOption);
  /**
   * Static representation of the one-to-one navigation property [[userNav]] for query construction.
   * Use to reference this property in query operations such as 'select' in the fluent request API.
   */
  export const USER_NAV: OneToOneLink<EmpJobRelationships, User> = new OneToOneLink('userNav', EmpJobRelationships, User);
  /**
   * All fields of the EmpJobRelationships entity.
   */
  export const _allFields: Array<StringField<EmpJobRelationships> | DateField<EmpJobRelationships> | OneToOneLink<EmpJobRelationships, EmpEmployment> | OneToOneLink<EmpJobRelationships, User> | OneToOneLink<EmpJobRelationships, PicklistOption>> = [
