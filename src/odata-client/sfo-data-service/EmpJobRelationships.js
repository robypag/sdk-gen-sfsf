...
var EmpJobRelationships = /** @class */ (function (_super) {
    ...
    EmpJobRelationships.builder = function () {
        return core_1.Entity.entityBuilder(EmpJobRelationships);
    };
    /**
    ...
    EmpJobRelationships.customField = function (fieldName) {
        return core_1.Entity.customFieldSelector(fieldName, EmpJobRelationships);
    };
    /**
     ...
     */
    EmpJobRelationships._defaultServicePath = 'VALUE_IS_UNDEFINED';
...
(function (EmpJobRelationships) {
     ...
     */
    EmpJobRelationships.CREATED_BY = new core_1.StringField('createdBy', EmpJobRelationships, 'Edm.String');
    /**
     * Static representation of the [[createdDateTime]] property for query construction.
     * Use to reference this property in query operations such as 'select' in the fluent request API.
     */
    EmpJobRelationships.CREATED_DATE_TIME = new core_1.DateField('createdDateTime', EmpJobRelationships, 'Edm.DateTimeOffset');
    /**
     * Static representation of the [[createdOn]] property for query construction.
     * Use to reference this property in query operations such as 'select' in the fluent request API.
     */
    EmpJobRelationships.CREATED_ON = new core_1.DateField('createdOn', EmpJobRelationships, 'Edm.DateTime');
    /**
     * Static representation of the [[endDate]] property for query construction.
     * Use to reference this property in query operations such as 'select' in the fluent request API.
     */
    EmpJobRelationships.END_DATE = new core_1.DateField('endDate', EmpJobRelationships, 'Edm.DateTime');
    /**
     * Static representation of the [[lastModifiedBy]] property for query construction.
     * Use to reference this property in query operations such as 'select' in the fluent request API.
     */
    EmpJobRelationships.LAST_MODIFIED_BY = new core_1.StringField('lastModifiedBy', EmpJobRelationships, 'Edm.String');
    /**
     * Static representation of the [[lastModifiedDateTime]] property for query construction.
     * Use to reference this property in query operations such as 'select' in the fluent request API.
     */
    EmpJobRelationships.LAST_MODIFIED_DATE_TIME = new core_1.DateField('lastModifiedDateTime', EmpJobRelationships, 'Edm.DateTimeOffset');
    /**
     * Static representation of the [[lastModifiedOn]] property for query construction.
     * Use to reference this property in query operations such as 'select' in the fluent request API.
     */
    EmpJobRelationships.LAST_MODIFIED_ON = new core_1.DateField('lastModifiedOn', EmpJobRelationships, 'Edm.DateTime');
    /**
     * Static representation of the [[operation]] property for query construction.
     * Use to reference this property in query operations such as 'select' in the fluent request API.
     */
    EmpJobRelationships.OPERATION = new core_1.StringField('operation', EmpJobRelationships, 'Edm.String');
    /**
     * Static representation of the [[relUserId]] property for query construction.
     * Use to reference this property in query operations such as 'select' in the fluent request API.
     */
    EmpJobRelationships.REL_USER_ID = new core_1.StringField('relUserId', EmpJobRelationships, 'Edm.String');
    /**
     * Static representation of the [[relationshipType]] property for query construction.
     * Use to reference this property in query operations such as 'select' in the fluent request API.
     */
    EmpJobRelationships.RELATIONSHIP_TYPE = new core_1.StringField('relationshipType', EmpJobRelationships, 'Edm.String');
    /**
     * Static representation of the [[startDate]] property for query construction.
     * Use to reference this property in query operations such as 'select' in the fluent request API.
     */
    EmpJobRelationships.START_DATE = new core_1.DateField('startDate', EmpJobRelationships, 'Edm.DateTime');
    /**
     * Static representation of the [[userId]] property for query construction.
     * Use to reference this property in query operations such as 'select' in the fluent request API.
     */
    EmpJobRelationships.USER_ID = new core_1.StringField('userId', EmpJobRelationships, 'Edm.String');
    /**
     * Static representation of the one-to-one navigation property [[employmentNav]] for query construction.
     * Use to reference this property in query operations such as 'select' in the fluent request API.
     */
    EmpJobRelationships.EMPLOYMENT_NAV = new core_1.OneToOneLink('employmentNav', EmpJobRelationships, EmpEmployment_1.EmpEmployment);
    /**
     * Static representation of the one-to-one navigation property [[relEmploymentNav]] for query construction.
     * Use to reference this property in query operations such as 'select' in the fluent request API.
     */
    EmpJobRelationships.REL_EMPLOYMENT_NAV = new core_1.OneToOneLink('relEmploymentNav', EmpJobRelationships, EmpEmployment_1.EmpEmployment);
    /**
     * Static representation of the one-to-one navigation property [[relUserNav]] for query construction.
     * Use to reference this property in query operations such as 'select' in the fluent request API.
     */
    EmpJobRelationships.REL_USER_NAV = new core_1.OneToOneLink('relUserNav', EmpJobRelationships, User_1.User);
    /**
     * Static representation of the one-to-one navigation property [[relationshipTypeNav]] for query construction.
     * Use to reference this property in query operations such as 'select' in the fluent request API.
     */
    EmpJobRelationships.RELATIONSHIP_TYPE_NAV = new core_1.OneToOneLink('relationshipTypeNav', EmpJobRelationships, PicklistOption_1.PicklistOption);
    /**
     * Static representation of the one-to-one navigation property [[userNav]] for query construction.
     * Use to reference this property in query operations such as 'select' in the fluent request API.
     */
    EmpJobRelationships.USER_NAV = new core_1.OneToOneLink('userNav', EmpJobRelationships, User_1.User);
    /**
    ...
    EmpJobRelationships._allFields = [
        ...
        EmpJobRelationships.REL_USER_NAV,
        EmpJobRelationships.RELATIONSHIP_TYPE_NAV,
        EmpJobRelationships.USER_NAV
    ];
    /**
     * All fields selector.
     */
    EmpJobRelationships.ALL_FIELDS = new core_1.AllFields('*', EmpJobRelationships);
    /**
