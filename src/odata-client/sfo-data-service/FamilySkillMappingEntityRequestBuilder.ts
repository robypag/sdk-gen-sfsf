 ...
 */
export class FamilySkillMappingEntityRequestBuilder extends RequestBuilder<FamilySkillMappingEntity> {
  /**
  ...
  getByKey(familyEntityExternalCode: string, externalCode: string): GetByKeyRequestBuilder<FamilySkillMappingEntity> {
    return new GetByKeyRequestBuilder(FamilySkillMappingEntity, {
  ...
  getAll(): GetAllRequestBuilder<FamilySkillMappingEntity> {
    return new GetAllRequestBuilder(FamilySkillMappingEntity);
  }
  ...
  create(entity: FamilySkillMappingEntity): CreateRequestBuilder<FamilySkillMappingEntity> {
    return new CreateRequestBuilder(FamilySkillMappingEntity, entity);
  }
  ...
  update(entity: FamilySkillMappingEntity): UpdateRequestBuilder<FamilySkillMappingEntity> {
    return new UpdateRequestBuilder(FamilySkillMappingEntity, entity);
  }
  ...
  delete(familyEntityExternalCodeOrEntity: any, externalCode?: string): DeleteRequestBuilder<FamilySkillMappingEntity> {
    return new DeleteRequestBuilder(FamilySkillMappingEntity, familyEntityExternalCodeOrEntity instanceof FamilySkillMappingEntity ? familyEntityExternalCodeOrEntity : {
