...
var CandidateProfileExtensionRequestBuilder = /** @class */ (function (_super) {
    ...
    CandidateProfileExtensionRequestBuilder.prototype.getByKey = function (candidateId) {
        return new core_1.GetByKeyRequestBuilder(CandidateProfileExtension_1.CandidateProfileExtension, { candidateId: candidateId });
    };
    /**
    ...
    CandidateProfileExtensionRequestBuilder.prototype.getAll = function () {
        return new core_1.GetAllRequestBuilder(CandidateProfileExtension_1.CandidateProfileExtension);
    };
    /**
    ...
    CandidateProfileExtensionRequestBuilder.prototype.create = function (entity) {
        return new core_1.CreateRequestBuilder(CandidateProfileExtension_1.CandidateProfileExtension, entity);
    };
    /**
    ...
    CandidateProfileExtensionRequestBuilder.prototype.update = function (entity) {
        return new core_1.UpdateRequestBuilder(CandidateProfileExtension_1.CandidateProfileExtension, entity);
    };
    CandidateProfileExtensionRequestBuilder.prototype.delete = function (candidateIdOrEntity) {
        return new core_1.DeleteRequestBuilder(CandidateProfileExtension_1.CandidateProfileExtension, candidateIdOrEntity instanceof CandidateProfileExtension_1.CandidateProfileExtension ? candidateIdOrEntity : { candidateId: candidateIdOrEntity });
    };
