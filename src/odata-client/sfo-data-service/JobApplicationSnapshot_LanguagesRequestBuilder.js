...
var JobApplicationSnapshot_LanguagesRequestBuilder = /** @class */ (function (_super) {
    ...
    JobApplicationSnapshot_LanguagesRequestBuilder.prototype.getByKey = function (backgroundElementId) {
        return new core_1.GetByKeyRequestBuilder(JobApplicationSnapshot_Languages_1.JobApplicationSnapshot_Languages, { backgroundElementId: backgroundElementId });
    };
    /**
    ...
    JobApplicationSnapshot_LanguagesRequestBuilder.prototype.getAll = function () {
        return new core_1.GetAllRequestBuilder(JobApplicationSnapshot_Languages_1.JobApplicationSnapshot_Languages);
    };
