 ...
 */
export class PerGlobalInfoNzlRequestBuilder extends RequestBuilder<PerGlobalInfoNzl> {
  /**
  ...
  getByKey(country: string, personIdExternal: string, startDate: Moment): GetByKeyRequestBuilder<PerGlobalInfoNzl> {
    return new GetByKeyRequestBuilder(PerGlobalInfoNzl, {
      country: country,
  ...
  getAll(): GetAllRequestBuilder<PerGlobalInfoNzl> {
    return new GetAllRequestBuilder(PerGlobalInfoNzl);
  }
}
