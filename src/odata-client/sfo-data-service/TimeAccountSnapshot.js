...
var TimeAccountSnapshot = /** @class */ (function (_super) {
     ...
     */
    TimeAccountSnapshot._defaultServicePath = 'VALUE_IS_UNDEFINED';
...
(function (TimeAccountSnapshot) {
     ...
     * Use to reference this property in query operations such as 'select' in the fluent request API.
     */
    TimeAccountSnapshot.ACCOUNT_TYPE_NAV = new core_1.OneToOneLink('accountTypeNav', TimeAccountSnapshot, TimeAccountType_1.TimeAccountType);
    /**
     * Static representation of the one-to-one navigation property [[createdByNav]] for query construction.
     * Use to reference this property in query operations such as 'select' in the fluent request API.
     */
    TimeAccountSnapshot.CREATED_BY_NAV = new core_1.OneToOneLink('createdByNav', TimeAccountSnapshot, User_1.User);
    /**
     * Static representation of the one-to-one navigation property [[lastModifiedByNav]] for query construction.
     * Use to reference this property in query operations such as 'select' in the fluent request API.
     */
    TimeAccountSnapshot.LAST_MODIFIED_BY_NAV = new core_1.OneToOneLink('lastModifiedByNav', TimeAccountSnapshot, User_1.User);
    /**
     * Static representation of the one-to-one navigation property [[mdfSystemRecordStatusNav]] for query construction.
     * Use to reference this property in query operations such as 'select' in the fluent request API.
     */
    TimeAccountSnapshot.MDF_SYSTEM_RECORD_STATUS_NAV = new core_1.OneToOneLink('mdfSystemRecordStatusNav', TimeAccountSnapshot, MdfEnumValue_1.MdfEnumValue);
    /**
     * Static representation of the one-to-one navigation property [[unitNav]] for query construction.
     * Use to reference this property in query operations such as 'select' in the fluent request API.
     */
    TimeAccountSnapshot.UNIT_NAV = new core_1.OneToOneLink('unitNav', TimeAccountSnapshot, MdfEnumValue_1.MdfEnumValue);
    /**
     * Static representation of the one-to-one navigation property [[userIdNav]] for query construction.
     * Use to reference this property in query operations such as 'select' in the fluent request API.
     */
    TimeAccountSnapshot.USER_ID_NAV = new core_1.OneToOneLink('userIdNav', TimeAccountSnapshot, User_1.User);
    /**
     * Static representation of the one-to-many navigation property [[wfRequestNav]] for query construction.
     * Use to reference this property in query operations such as 'select' in the fluent request API.
     */
    TimeAccountSnapshot.WF_REQUEST_NAV = new core_1.Link('wfRequestNav', TimeAccountSnapshot, WfRequest_1.WfRequest);
    /**
