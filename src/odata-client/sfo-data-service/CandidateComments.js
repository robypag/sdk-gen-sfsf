...
var CandidateComments = /** @class */ (function (_super) {
    ...
    CandidateComments.builder = function () {
        return core_1.Entity.entityBuilder(CandidateComments);
    };
    /**
    ...
    CandidateComments.customField = function (fieldName) {
        return core_1.Entity.customFieldSelector(fieldName, CandidateComments);
    };
    /**
     ...
     */
    CandidateComments._defaultServicePath = 'VALUE_IS_UNDEFINED';
