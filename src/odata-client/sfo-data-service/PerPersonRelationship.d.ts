...
export declare namespace PerPersonRelationship {
     ...
     * Use to reference this property in query operations such as 'select' in the fluent request API.
     */
    const ADDRESS_ADDRESS_10: StringField<PerPersonRelationship>;
    /**
     * Static representation of the [[addressAddress11]] property for query construction.
     * Use to reference this property in query operations such as 'select' in the fluent request API.
     */
    const ADDRESS_ADDRESS_11: StringField<PerPersonRelationship>;
    /**
     * Static representation of the [[addressAddress12]] property for query construction.
     * Use to reference this property in query operations such as 'select' in the fluent request API.
     */
    const ADDRESS_ADDRESS_12: StringField<PerPersonRelationship>;
    /**
     ...
     * Use to reference this property in query operations such as 'select' in the fluent request API.
     */
    const ADDRESS_NOTES: StringField<PerPersonRelationship>;
    /**
