 ...
 */
export class SpotAwardCategoryRequestBuilder extends RequestBuilder<SpotAwardCategory> {
  /**
  ...
  getByKey(spotAwardProgramExternalCode: string, externalCode: string): GetByKeyRequestBuilder<SpotAwardCategory> {
    return new GetByKeyRequestBuilder(SpotAwardCategory, {
  ...
  getAll(): GetAllRequestBuilder<SpotAwardCategory> {
    return new GetAllRequestBuilder(SpotAwardCategory);
  }
  ...
  create(entity: SpotAwardCategory): CreateRequestBuilder<SpotAwardCategory> {
    return new CreateRequestBuilder(SpotAwardCategory, entity);
  }
  ...
  update(entity: SpotAwardCategory): UpdateRequestBuilder<SpotAwardCategory> {
    return new UpdateRequestBuilder(SpotAwardCategory, entity);
  }
  ...
  delete(spotAwardProgramExternalCodeOrEntity: any, externalCode?: string): DeleteRequestBuilder<SpotAwardCategory> {
    return new DeleteRequestBuilder(SpotAwardCategory, spotAwardProgramExternalCodeOrEntity instanceof SpotAwardCategory ? spotAwardProgramExternalCodeOrEntity : {
