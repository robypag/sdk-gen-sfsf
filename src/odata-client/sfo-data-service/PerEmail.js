...
var PerEmail = /** @class */ (function (_super) {
    ...
    PerEmail.builder = function () {
        return core_1.Entity.entityBuilder(PerEmail);
    };
    /**
    ...
    PerEmail.customField = function (fieldName) {
        return core_1.Entity.customFieldSelector(fieldName, PerEmail);
    };
    /**
     ...
     */
    PerEmail._defaultServicePath = 'VALUE_IS_UNDEFINED';
    return PerEmail;
}(core_1.Entity));
...
(function (PerEmail) {
     ...
     */
    PerEmail.CREATED_BY = new core_1.StringField('createdBy', PerEmail, 'Edm.String');
    /**
     * Static representation of the [[createdDateTime]] property for query construction.
     * Use to reference this property in query operations such as 'select' in the fluent request API.
     */
    PerEmail.CREATED_DATE_TIME = new core_1.DateField('createdDateTime', PerEmail, 'Edm.DateTimeOffset');
    /**
     * Static representation of the [[createdOn]] property for query construction.
     * Use to reference this property in query operations such as 'select' in the fluent request API.
     */
    PerEmail.CREATED_ON = new core_1.DateField('createdOn', PerEmail, 'Edm.DateTime');
    /**
     * Static representation of the [[emailAddress]] property for query construction.
     * Use to reference this property in query operations such as 'select' in the fluent request API.
     */
    PerEmail.EMAIL_ADDRESS = new core_1.StringField('emailAddress', PerEmail, 'Edm.String');
    /**
     * Static representation of the [[emailType]] property for query construction.
     * Use to reference this property in query operations such as 'select' in the fluent request API.
     */
    PerEmail.EMAIL_TYPE = new core_1.StringField('emailType', PerEmail, 'Edm.String');
    /**
     * Static representation of the [[includeAllRecords]] property for query construction.
     * Use to reference this property in query operations such as 'select' in the fluent request API.
     */
    PerEmail.INCLUDE_ALL_RECORDS = new core_1.BooleanField('includeAllRecords', PerEmail, 'Edm.Boolean');
    /**
     * Static representation of the [[isPrimary]] property for query construction.
     * Use to reference this property in query operations such as 'select' in the fluent request API.
     */
    PerEmail.IS_PRIMARY = new core_1.BooleanField('isPrimary', PerEmail, 'Edm.Boolean');
    /**
     * Static representation of the [[lastModifiedBy]] property for query construction.
     * Use to reference this property in query operations such as 'select' in the fluent request API.
     */
    PerEmail.LAST_MODIFIED_BY = new core_1.StringField('lastModifiedBy', PerEmail, 'Edm.String');
    /**
     * Static representation of the [[lastModifiedDateTime]] property for query construction.
     * Use to reference this property in query operations such as 'select' in the fluent request API.
     */
    PerEmail.LAST_MODIFIED_DATE_TIME = new core_1.DateField('lastModifiedDateTime', PerEmail, 'Edm.DateTimeOffset');
    /**
     * Static representation of the [[lastModifiedOn]] property for query construction.
     * Use to reference this property in query operations such as 'select' in the fluent request API.
     */
    PerEmail.LAST_MODIFIED_ON = new core_1.DateField('lastModifiedOn', PerEmail, 'Edm.DateTime');
    /**
     * Static representation of the [[operation]] property for query construction.
     * Use to reference this property in query operations such as 'select' in the fluent request API.
     */
    PerEmail.OPERATION = new core_1.StringField('operation', PerEmail, 'Edm.String');
    /**
     * Static representation of the [[personIdExternal]] property for query construction.
     * Use to reference this property in query operations such as 'select' in the fluent request API.
     */
    PerEmail.PERSON_ID_EXTERNAL = new core_1.StringField('personIdExternal', PerEmail, 'Edm.String');
    /**
     * Static representation of the one-to-one navigation property [[emailTypeNav]] for query construction.
     * Use to reference this property in query operations such as 'select' in the fluent request API.
     */
    PerEmail.EMAIL_TYPE_NAV = new core_1.OneToOneLink('emailTypeNav', PerEmail, PicklistOption_1.PicklistOption);
    /**
     * Static representation of the one-to-one navigation property [[personNav]] for query construction.
     * Use to reference this property in query operations such as 'select' in the fluent request API.
     */
    PerEmail.PERSON_NAV = new core_1.OneToOneLink('personNav', PerEmail, PerPerson_1.PerPerson);
    /**
    ...
    PerEmail._allFields = [
        ...
        PerEmail.EMAIL_TYPE_NAV,
        PerEmail.PERSON_NAV
    ];
    /**
     * All fields selector.
     */
    PerEmail.ALL_FIELDS = new core_1.AllFields('*', PerEmail);
    /**
