 ...
 */
export class PaymentInformationDetailV3MmrRequestBuilder extends RequestBuilder<PaymentInformationDetailV3Mmr> {
  /**
  ...
  getByKey(paymentInformationDetailV3ExternalCode: BigNumber, paymentInformationV3EffectiveStartDate: Moment, paymentInformationV3Worker: string, externalCode: BigNumber): GetByKeyRequestBuilder<PaymentInformationDetailV3Mmr> {
    return new GetByKeyRequestBuilder(PaymentInformationDetailV3Mmr, {
  ...
  getAll(): GetAllRequestBuilder<PaymentInformationDetailV3Mmr> {
    return new GetAllRequestBuilder(PaymentInformationDetailV3Mmr);
  }
  ...
  create(entity: PaymentInformationDetailV3Mmr): CreateRequestBuilder<PaymentInformationDetailV3Mmr> {
    return new CreateRequestBuilder(PaymentInformationDetailV3Mmr, entity);
  }
  ...
  update(entity: PaymentInformationDetailV3Mmr): UpdateRequestBuilder<PaymentInformationDetailV3Mmr> {
    return new UpdateRequestBuilder(PaymentInformationDetailV3Mmr, entity);
  }
  ...
  delete(paymentInformationDetailV3ExternalCodeOrEntity: any, paymentInformationV3EffectiveStartDate?: Moment, paymentInformationV3Worker?: string, externalCode?: BigNumber): DeleteRequestBuilder<PaymentInformationDetailV3Mmr> {
    return new DeleteRequestBuilder(PaymentInformationDetailV3Mmr, paymentInformationDetailV3ExternalCodeOrEntity instanceof PaymentInformationDetailV3Mmr ? paymentInformationDetailV3ExternalCodeOrEntity : {
