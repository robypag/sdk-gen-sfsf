 ...
 */
export class DgPeoplePoolRequestBuilder extends RequestBuilder<DgPeoplePool> {
  /**
  ...
  getByKey(peoplePoolId: string): GetByKeyRequestBuilder<DgPeoplePool> {
    return new GetByKeyRequestBuilder(DgPeoplePool, { peoplePoolId: peoplePoolId });
  }
  ...
  getAll(): GetAllRequestBuilder<DgPeoplePool> {
    return new GetAllRequestBuilder(DgPeoplePool);
  }
}
