...
export namespace PerPhone {
   ...
   * Use to reference this property in query operations such as 'select' in the fluent request API.
   */
  export const PHONE_TYPE_NAV: OneToOneLink<PerPhone, PicklistOption> = new OneToOneLink('phoneTypeNav', PerPhone, PicklistOption);
  /**
   * All fields of the PerPhone entity.
   */
  export const _allFields: Array<StringField<PerPhone> | DateField<PerPhone> | BooleanField<PerPhone> | OneToOneLink<PerPhone, PerPerson> | OneToOneLink<PerPhone, PicklistOption>> = [
    PerPhone.AREA_CODE,
