...
var EmployeeTimeAus = /** @class */ (function (_super) {
     ...
     */
    EmployeeTimeAus._defaultServicePath = 'VALUE_IS_UNDEFINED';
...
(function (EmployeeTimeAus) {
     ...
     * Use to reference this property in query operations such as 'select' in the fluent request API.
     */
    EmployeeTimeAus.CREATED_BY_NAV = new core_1.OneToOneLink('createdByNav', EmployeeTimeAus, User_1.User);
    /**
     * Static representation of the one-to-one navigation property [[lastModifiedByNav]] for query construction.
     * Use to reference this property in query operations such as 'select' in the fluent request API.
     */
    EmployeeTimeAus.LAST_MODIFIED_BY_NAV = new core_1.OneToOneLink('lastModifiedByNav', EmployeeTimeAus, User_1.User);
    /**
     * Static representation of the one-to-one navigation property [[mdfSystemRecordStatusNav]] for query construction.
     * Use to reference this property in query operations such as 'select' in the fluent request API.
     */
    EmployeeTimeAus.MDF_SYSTEM_RECORD_STATUS_NAV = new core_1.OneToOneLink('mdfSystemRecordStatusNav', EmployeeTimeAus, MdfEnumValue_1.MdfEnumValue);
    /**
