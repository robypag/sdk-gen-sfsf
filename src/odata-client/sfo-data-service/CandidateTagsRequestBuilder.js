...
var CandidateTagsRequestBuilder = /** @class */ (function (_super) {
    ...
    CandidateTagsRequestBuilder.prototype.getByKey = function (tagId) {
        return new core_1.GetByKeyRequestBuilder(CandidateTags_1.CandidateTags, { tagId: tagId });
    };
    /**
    ...
    CandidateTagsRequestBuilder.prototype.getAll = function () {
        return new core_1.GetAllRequestBuilder(CandidateTags_1.CandidateTags);
    };
    /**
    ...
    CandidateTagsRequestBuilder.prototype.create = function (entity) {
        return new core_1.CreateRequestBuilder(CandidateTags_1.CandidateTags, entity);
    };
    /**
    ...
    CandidateTagsRequestBuilder.prototype.update = function (entity) {
        return new core_1.UpdateRequestBuilder(CandidateTags_1.CandidateTags, entity);
    };
