...
export declare namespace EmployeeTimeCol {
     ...
     * Use to reference this property in query operations such as 'select' in the fluent request API.
     */
    const CREATED_BY_NAV: OneToOneLink<EmployeeTimeCol, User>;
    /**
     ...
     * Use to reference this property in query operations such as 'select' in the fluent request API.
     */
    const LAST_MODIFIED_BY_NAV: OneToOneLink<EmployeeTimeCol, User>;
    /**
     * Static representation of the one-to-one navigation property [[mdfSystemRecordStatusNav]] for query construction.
     * Use to reference this property in query operations such as 'select' in the fluent request API.
     */
    const MDF_SYSTEM_RECORD_STATUS_NAV: OneToOneLink<EmployeeTimeCol, MdfEnumValue>;
    /**
     * All fields of the EmployeeTimeCol entity.
     */
    const _allFields: Array<StringField<EmployeeTimeCol> | DateField<EmployeeTimeCol> | BigNumberField<EmployeeTimeCol> | OneToOneLink<EmployeeTimeCol, User> | OneToOneLink<EmployeeTimeCol, EmployeeTimeGroup> | OneToOneLink<EmployeeTimeCol, MdfEnumValue>>;
    /**
     * All fields selector.
     */
