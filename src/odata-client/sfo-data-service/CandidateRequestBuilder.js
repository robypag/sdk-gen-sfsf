...
var CandidateRequestBuilder = /** @class */ (function (_super) {
    ...
    CandidateRequestBuilder.prototype.getByKey = function (candidateId) {
        return new core_1.GetByKeyRequestBuilder(Candidate_1.Candidate, { candidateId: candidateId });
    };
    /**
    ...
    CandidateRequestBuilder.prototype.getAll = function () {
        return new core_1.GetAllRequestBuilder(Candidate_1.Candidate);
    };
    /**
    ...
    CandidateRequestBuilder.prototype.create = function (entity) {
        return new core_1.CreateRequestBuilder(Candidate_1.Candidate, entity);
    };
    /**
    ...
    CandidateRequestBuilder.prototype.update = function (entity) {
        return new core_1.UpdateRequestBuilder(Candidate_1.Candidate, entity);
    };
