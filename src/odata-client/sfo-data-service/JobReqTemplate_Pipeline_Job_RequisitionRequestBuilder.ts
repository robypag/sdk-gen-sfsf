 ...
 */
export class JobReqTemplate_Pipeline_Job_RequisitionRequestBuilder extends RequestBuilder<JobReqTemplate_Pipeline_Job_Requisition> {
  /**
  ...
  getByKey(templateId: BigNumber): GetByKeyRequestBuilder<JobReqTemplate_Pipeline_Job_Requisition> {
    return new GetByKeyRequestBuilder(JobReqTemplate_Pipeline_Job_Requisition, { templateId: templateId });
  }
  ...
  getAll(): GetAllRequestBuilder<JobReqTemplate_Pipeline_Job_Requisition> {
    return new GetAllRequestBuilder(JobReqTemplate_Pipeline_Job_Requisition);
  }
}
