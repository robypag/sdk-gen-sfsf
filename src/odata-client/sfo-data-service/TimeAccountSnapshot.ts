...
export namespace TimeAccountSnapshot {
   ...
   * Use to reference this property in query operations such as 'select' in the fluent request API.
   */
  export const ACCOUNT_TYPE_NAV: OneToOneLink<TimeAccountSnapshot, TimeAccountType> = new OneToOneLink('accountTypeNav', TimeAccountSnapshot, TimeAccountType);
  /**
   * Static representation of the one-to-one navigation property [[createdByNav]] for query construction.
   * Use to reference this property in query operations such as 'select' in the fluent request API.
   */
  export const CREATED_BY_NAV: OneToOneLink<TimeAccountSnapshot, User> = new OneToOneLink('createdByNav', TimeAccountSnapshot, User);
  /**
   * Static representation of the one-to-one navigation property [[lastModifiedByNav]] for query construction.
   * Use to reference this property in query operations such as 'select' in the fluent request API.
   */
  export const LAST_MODIFIED_BY_NAV: OneToOneLink<TimeAccountSnapshot, User> = new OneToOneLink('lastModifiedByNav', TimeAccountSnapshot, User);
  /**
   * Static representation of the one-to-one navigation property [[mdfSystemRecordStatusNav]] for query construction.
   * Use to reference this property in query operations such as 'select' in the fluent request API.
   */
  export const MDF_SYSTEM_RECORD_STATUS_NAV: OneToOneLink<TimeAccountSnapshot, MdfEnumValue> = new OneToOneLink('mdfSystemRecordStatusNav', TimeAccountSnapshot, MdfEnumValue);
  /**
   * Static representation of the one-to-one navigation property [[unitNav]] for query construction.
   * Use to reference this property in query operations such as 'select' in the fluent request API.
   */
  export const UNIT_NAV: OneToOneLink<TimeAccountSnapshot, MdfEnumValue> = new OneToOneLink('unitNav', TimeAccountSnapshot, MdfEnumValue);
  /**
   * Static representation of the one-to-one navigation property [[userIdNav]] for query construction.
   * Use to reference this property in query operations such as 'select' in the fluent request API.
   */
  export const USER_ID_NAV: OneToOneLink<TimeAccountSnapshot, User> = new OneToOneLink('userIdNav', TimeAccountSnapshot, User);
  /**
   * Static representation of the one-to-many navigation property [[wfRequestNav]] for query construction.
   * Use to reference this property in query operations such as 'select' in the fluent request API.
   */
  export const WF_REQUEST_NAV: Link<TimeAccountSnapshot, WfRequest> = new Link('wfRequestNav', TimeAccountSnapshot, WfRequest);
  /**
   * All fields of the TimeAccountSnapshot entity.
   */
  export const _allFields: Array<StringField<TimeAccountSnapshot> | BigNumberField<TimeAccountSnapshot> | BooleanField<TimeAccountSnapshot> | DateField<TimeAccountSnapshot> | OneToOneLink<TimeAccountSnapshot, TimeAccountType> | OneToOneLink<TimeAccountSnapshot, User> | OneToOneLink<TimeAccountSnapshot, MdfEnumValue> | Link<TimeAccountSnapshot, WfRequest>> = [
    ...
    TimeAccountSnapshot.CREATED_BY_NAV,
    TimeAccountSnapshot.LAST_MODIFIED_BY_NAV,
    TimeAccountSnapshot.MDF_SYSTEM_RECORD_STATUS_NAV,
    TimeAccountSnapshot.UNIT_NAV,
    TimeAccountSnapshot.USER_ID_NAV,
    TimeAccountSnapshot.WF_REQUEST_NAV
  ];
  /**
   * All fields selector.
   */
