...
export namespace PerEmail {
   ...
   * Use to reference this property in query operations such as 'select' in the fluent request API.
   */
  export const EMAIL_TYPE_NAV: OneToOneLink<PerEmail, PicklistOption> = new OneToOneLink('emailTypeNav', PerEmail, PicklistOption);
  /**
   ...
   */
  export const _allFields: Array<StringField<PerEmail> | DateField<PerEmail> | BooleanField<PerEmail> | OneToOneLink<PerEmail, PicklistOption> | OneToOneLink<PerEmail, PerPerson>> = [
    PerEmail.CREATED_BY,
