...
var CandidateCommentsRequestBuilder = /** @class */ (function (_super) {
    ...
    CandidateCommentsRequestBuilder.prototype.getByKey = function (commentId) {
        return new core_1.GetByKeyRequestBuilder(CandidateComments_1.CandidateComments, { commentId: commentId });
    };
    /**
    ...
    CandidateCommentsRequestBuilder.prototype.getAll = function () {
        return new core_1.GetAllRequestBuilder(CandidateComments_1.CandidateComments);
    };
    /**
    ...
    CandidateCommentsRequestBuilder.prototype.create = function (entity) {
        return new core_1.CreateRequestBuilder(CandidateComments_1.CandidateComments, entity);
    };
    /**
    ...
    CandidateCommentsRequestBuilder.prototype.update = function (entity) {
        return new core_1.UpdateRequestBuilder(CandidateComments_1.CandidateComments, entity);
    };
