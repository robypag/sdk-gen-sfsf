...
var CandidateLightRequestBuilder = /** @class */ (function (_super) {
    ...
    CandidateLightRequestBuilder.prototype.getByKey = function (candidateId) {
        return new core_1.GetByKeyRequestBuilder(CandidateLight_1.CandidateLight, { candidateId: candidateId });
    };
    /**
    ...
    CandidateLightRequestBuilder.prototype.getAll = function () {
        return new core_1.GetAllRequestBuilder(CandidateLight_1.CandidateLight);
    };
    /**
    ...
    CandidateLightRequestBuilder.prototype.create = function (entity) {
        return new core_1.CreateRequestBuilder(CandidateLight_1.CandidateLight, entity);
    };
    /**
    ...
    CandidateLightRequestBuilder.prototype.update = function (entity) {
        return new core_1.UpdateRequestBuilder(CandidateLight_1.CandidateLight, entity);
    };
