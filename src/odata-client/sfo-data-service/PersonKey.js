...
var PersonKey = /** @class */ (function (_super) {
    ...
    PersonKey.builder = function () {
        return core_1.Entity.entityBuilder(PersonKey);
    };
    /**
    ...
    PersonKey.customField = function (fieldName) {
        return core_1.Entity.customFieldSelector(fieldName, PersonKey);
    };
    /**
     ...
     */
    PersonKey._defaultServicePath = 'VALUE_IS_UNDEFINED';
    return PersonKey;
}(core_1.Entity));
...
(function (PersonKey) {
     ...
     */
    PersonKey.PER_PERSON_UUID = new core_1.StringField('perPersonUuid', PersonKey, 'Edm.String');
    /**
     * Static representation of the [[personId]] property for query construction.
     * Use to reference this property in query operations such as 'select' in the fluent request API.
     */
    PersonKey.PERSON_ID = new core_1.BigNumberField('personId', PersonKey, 'Edm.Int64');
    /**
     * Static representation of the [[personIdExternal]] property for query construction.
     * Use to reference this property in query operations such as 'select' in the fluent request API.
     */
    PersonKey.PERSON_ID_EXTERNAL = new core_1.StringField('personIdExternal', PersonKey, 'Edm.String');
    /**
     * Static representation of the one-to-one navigation property [[userAccountNav]] for query construction.
     * Use to reference this property in query operations such as 'select' in the fluent request API.
     */
    PersonKey.USER_ACCOUNT_NAV = new core_1.OneToOneLink('userAccountNav', PersonKey, UserAccount_1.UserAccount);
    /**
     ...
     * All fields selector.
     */
    PersonKey.ALL_FIELDS = new core_1.AllFields('*', PersonKey);
    /**
