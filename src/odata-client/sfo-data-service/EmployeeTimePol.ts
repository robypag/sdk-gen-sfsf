...
export namespace EmployeeTimePol {
   ...
   * Use to reference this property in query operations such as 'select' in the fluent request API.
   */
  export const CREATED_BY_NAV: OneToOneLink<EmployeeTimePol, User> = new OneToOneLink('createdByNav', EmployeeTimePol, User);
  /**
   * Static representation of the one-to-one navigation property [[lastModifiedByNav]] for query construction.
   * Use to reference this property in query operations such as 'select' in the fluent request API.
   */
  export const LAST_MODIFIED_BY_NAV: OneToOneLink<EmployeeTimePol, User> = new OneToOneLink('lastModifiedByNav', EmployeeTimePol, User);
  /**
   * Static representation of the one-to-one navigation property [[mdfSystemRecordStatusNav]] for query construction.
   * Use to reference this property in query operations such as 'select' in the fluent request API.
   */
  export const MDF_SYSTEM_RECORD_STATUS_NAV: OneToOneLink<EmployeeTimePol, MdfEnumValue> = new OneToOneLink('mdfSystemRecordStatusNav', EmployeeTimePol, MdfEnumValue);
  /**
   * All fields of the EmployeeTimePol entity.
   */
  export const _allFields: Array<StringField<EmployeeTimePol> | DateField<EmployeeTimePol> | BigNumberField<EmployeeTimePol> | OneToOneLink<EmployeeTimePol, User> | OneToOneLink<EmployeeTimePol, MdfEnumValue>> = [
    ...
    EmployeeTimePol.CREATED_BY_NAV,
    EmployeeTimePol.LAST_MODIFIED_BY_NAV,
    EmployeeTimePol.MDF_SYSTEM_RECORD_STATUS_NAV
  ];
  /**
   * All fields selector.
   */
