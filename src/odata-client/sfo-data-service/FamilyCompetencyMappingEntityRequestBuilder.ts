 ...
 */
export class FamilyCompetencyMappingEntityRequestBuilder extends RequestBuilder<FamilyCompetencyMappingEntity> {
  /**
  ...
  getByKey(familyEntityExternalCode: string, externalCode: string): GetByKeyRequestBuilder<FamilyCompetencyMappingEntity> {
    return new GetByKeyRequestBuilder(FamilyCompetencyMappingEntity, {
  ...
  getAll(): GetAllRequestBuilder<FamilyCompetencyMappingEntity> {
    return new GetAllRequestBuilder(FamilyCompetencyMappingEntity);
  }
  ...
  create(entity: FamilyCompetencyMappingEntity): CreateRequestBuilder<FamilyCompetencyMappingEntity> {
    return new CreateRequestBuilder(FamilyCompetencyMappingEntity, entity);
  }
  ...
  update(entity: FamilyCompetencyMappingEntity): UpdateRequestBuilder<FamilyCompetencyMappingEntity> {
    return new UpdateRequestBuilder(FamilyCompetencyMappingEntity, entity);
  }
  ...
  delete(familyEntityExternalCodeOrEntity: any, externalCode?: string): DeleteRequestBuilder<FamilyCompetencyMappingEntity> {
    return new DeleteRequestBuilder(FamilyCompetencyMappingEntity, familyEntityExternalCodeOrEntity instanceof FamilyCompetencyMappingEntity ? familyEntityExternalCodeOrEntity : {
