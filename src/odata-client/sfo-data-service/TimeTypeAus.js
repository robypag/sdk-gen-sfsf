...
var TimeTypeAus = /** @class */ (function (_super) {
     ...
     */
    TimeTypeAus._defaultServicePath = 'VALUE_IS_UNDEFINED';
    return TimeTypeAus;
}(core_1.Entity));
...
(function (TimeTypeAus) {
     ...
     * Use to reference this property in query operations such as 'select' in the fluent request API.
     */
    TimeTypeAus.CREATED_BY_NAV = new core_1.OneToOneLink('createdByNav', TimeTypeAus, User_1.User);
    /**
     * Static representation of the one-to-one navigation property [[lastModifiedByNav]] for query construction.
     * Use to reference this property in query operations such as 'select' in the fluent request API.
     */
    TimeTypeAus.LAST_MODIFIED_BY_NAV = new core_1.OneToOneLink('lastModifiedByNav', TimeTypeAus, User_1.User);
    /**
     * Static representation of the one-to-one navigation property [[mdfSystemRecordStatusNav]] for query construction.
     * Use to reference this property in query operations such as 'select' in the fluent request API.
     */
    TimeTypeAus.MDF_SYSTEM_RECORD_STATUS_NAV = new core_1.OneToOneLink('mdfSystemRecordStatusNav', TimeTypeAus, MdfEnumValue_1.MdfEnumValue);
    /**
