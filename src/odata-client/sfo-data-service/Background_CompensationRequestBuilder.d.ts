 ...
 */
export declare class Background_CompensationRequestBuilder extends RequestBuilder<Background_Compensation> {
    /**
...
//# sourceMappingURL=Background_CompensationRequestBuilder.d.ts.map