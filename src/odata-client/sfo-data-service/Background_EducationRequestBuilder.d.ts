 ...
 */
export declare class Background_EducationRequestBuilder extends RequestBuilder<Background_Education> {
    /**
...
//# sourceMappingURL=Background_EducationRequestBuilder.d.ts.map