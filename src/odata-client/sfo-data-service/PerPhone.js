...
var PerPhone = /** @class */ (function (_super) {
    ...
    PerPhone.builder = function () {
        return core_1.Entity.entityBuilder(PerPhone);
    };
    /**
    ...
    PerPhone.customField = function (fieldName) {
        return core_1.Entity.customFieldSelector(fieldName, PerPhone);
    };
    /**
     ...
     */
    PerPhone._defaultServicePath = 'VALUE_IS_UNDEFINED';
    return PerPhone;
}(core_1.Entity));
...
(function (PerPhone) {
     ...
     */
    PerPhone.AREA_CODE = new core_1.StringField('areaCode', PerPhone, 'Edm.String');
    /**
     * Static representation of the [[countryCode]] property for query construction.
     * Use to reference this property in query operations such as 'select' in the fluent request API.
     */
    PerPhone.COUNTRY_CODE = new core_1.StringField('countryCode', PerPhone, 'Edm.String');
    /**
     * Static representation of the [[createdBy]] property for query construction.
     * Use to reference this property in query operations such as 'select' in the fluent request API.
     */
    PerPhone.CREATED_BY = new core_1.StringField('createdBy', PerPhone, 'Edm.String');
    /**
     * Static representation of the [[createdDateTime]] property for query construction.
     * Use to reference this property in query operations such as 'select' in the fluent request API.
     */
    PerPhone.CREATED_DATE_TIME = new core_1.DateField('createdDateTime', PerPhone, 'Edm.DateTimeOffset');
    /**
     * Static representation of the [[createdOn]] property for query construction.
     * Use to reference this property in query operations such as 'select' in the fluent request API.
     */
    PerPhone.CREATED_ON = new core_1.DateField('createdOn', PerPhone, 'Edm.DateTime');
    /**
     * Static representation of the [[extension]] property for query construction.
     * Use to reference this property in query operations such as 'select' in the fluent request API.
     */
    PerPhone.EXTENSION = new core_1.StringField('extension', PerPhone, 'Edm.String');
    /**
     * Static representation of the [[includeAllRecords]] property for query construction.
     * Use to reference this property in query operations such as 'select' in the fluent request API.
     */
    PerPhone.INCLUDE_ALL_RECORDS = new core_1.BooleanField('includeAllRecords', PerPhone, 'Edm.Boolean');
    /**
     * Static representation of the [[isPrimary]] property for query construction.
     * Use to reference this property in query operations such as 'select' in the fluent request API.
     */
    PerPhone.IS_PRIMARY = new core_1.BooleanField('isPrimary', PerPhone, 'Edm.Boolean');
    /**
     * Static representation of the [[lastModifiedBy]] property for query construction.
     * Use to reference this property in query operations such as 'select' in the fluent request API.
     */
    PerPhone.LAST_MODIFIED_BY = new core_1.StringField('lastModifiedBy', PerPhone, 'Edm.String');
    /**
     * Static representation of the [[lastModifiedDateTime]] property for query construction.
     * Use to reference this property in query operations such as 'select' in the fluent request API.
     */
    PerPhone.LAST_MODIFIED_DATE_TIME = new core_1.DateField('lastModifiedDateTime', PerPhone, 'Edm.DateTimeOffset');
    /**
     * Static representation of the [[lastModifiedOn]] property for query construction.
     * Use to reference this property in query operations such as 'select' in the fluent request API.
     */
    PerPhone.LAST_MODIFIED_ON = new core_1.DateField('lastModifiedOn', PerPhone, 'Edm.DateTime');
    /**
     * Static representation of the [[operation]] property for query construction.
     * Use to reference this property in query operations such as 'select' in the fluent request API.
     */
    PerPhone.OPERATION = new core_1.StringField('operation', PerPhone, 'Edm.String');
    /**
     * Static representation of the [[personIdExternal]] property for query construction.
     * Use to reference this property in query operations such as 'select' in the fluent request API.
     */
    PerPhone.PERSON_ID_EXTERNAL = new core_1.StringField('personIdExternal', PerPhone, 'Edm.String');
    /**
     * Static representation of the [[phoneNumber]] property for query construction.
     * Use to reference this property in query operations such as 'select' in the fluent request API.
     */
    PerPhone.PHONE_NUMBER = new core_1.StringField('phoneNumber', PerPhone, 'Edm.String');
    /**
     * Static representation of the [[phoneType]] property for query construction.
     * Use to reference this property in query operations such as 'select' in the fluent request API.
     */
    PerPhone.PHONE_TYPE = new core_1.StringField('phoneType', PerPhone, 'Edm.String');
    /**
     * Static representation of the one-to-one navigation property [[personNav]] for query construction.
     * Use to reference this property in query operations such as 'select' in the fluent request API.
     */
    PerPhone.PERSON_NAV = new core_1.OneToOneLink('personNav', PerPhone, PerPerson_1.PerPerson);
    /**
     * Static representation of the one-to-one navigation property [[phoneTypeNav]] for query construction.
     * Use to reference this property in query operations such as 'select' in the fluent request API.
     */
    PerPhone.PHONE_TYPE_NAV = new core_1.OneToOneLink('phoneTypeNav', PerPhone, PicklistOption_1.PicklistOption);
    /**
    ...
    PerPhone._allFields = [
        ...
        PerPhone.PHONE_TYPE,
        PerPhone.PERSON_NAV,
        PerPhone.PHONE_TYPE_NAV
    ];
    /**
     * All fields selector.
     */
    PerPhone.ALL_FIELDS = new core_1.AllFields('*', PerPhone);
    /**
