...
var PerPerson = /** @class */ (function (_super) {
    ...
    PerPerson.builder = function () {
        return core_1.Entity.entityBuilder(PerPerson);
    };
    /**
    ...
    PerPerson.customField = function (fieldName) {
        return core_1.Entity.customFieldSelector(fieldName, PerPerson);
    };
    /**
     ...
     */
    PerPerson._defaultServicePath = 'VALUE_IS_UNDEFINED';
    return PerPerson;
}(core_1.Entity));
...
(function (PerPerson) {
     ...
     */
    PerPerson.BIRTH_NAME = new core_1.StringField('birthName', PerPerson, 'Edm.String');
    /**
     * Static representation of the [[countryOfBirth]] property for query construction.
     * Use to reference this property in query operations such as 'select' in the fluent request API.
     */
    PerPerson.COUNTRY_OF_BIRTH = new core_1.StringField('countryOfBirth', PerPerson, 'Edm.String');
    /**
     * Static representation of the [[createdBy]] property for query construction.
     * Use to reference this property in query operations such as 'select' in the fluent request API.
     */
    PerPerson.CREATED_BY = new core_1.StringField('createdBy', PerPerson, 'Edm.String');
    /**
     * Static representation of the [[createdDateTime]] property for query construction.
     * Use to reference this property in query operations such as 'select' in the fluent request API.
     */
    PerPerson.CREATED_DATE_TIME = new core_1.DateField('createdDateTime', PerPerson, 'Edm.DateTimeOffset');
    /**
     * Static representation of the [[createdOn]] property for query construction.
     * Use to reference this property in query operations such as 'select' in the fluent request API.
     */
    PerPerson.CREATED_ON = new core_1.DateField('createdOn', PerPerson, 'Edm.DateTime');
    /**
     * Static representation of the [[dateOfBirth]] property for query construction.
     * Use to reference this property in query operations such as 'select' in the fluent request API.
     */
    PerPerson.DATE_OF_BIRTH = new core_1.DateField('dateOfBirth', PerPerson, 'Edm.DateTime');
    /**
     * Static representation of the [[includeAllRecords]] property for query construction.
     * Use to reference this property in query operations such as 'select' in the fluent request API.
     */
    PerPerson.INCLUDE_ALL_RECORDS = new core_1.BooleanField('includeAllRecords', PerPerson, 'Edm.Boolean');
    /**
     * Static representation of the [[lastModifiedBy]] property for query construction.
     * Use to reference this property in query operations such as 'select' in the fluent request API.
     */
    PerPerson.LAST_MODIFIED_BY = new core_1.StringField('lastModifiedBy', PerPerson, 'Edm.String');
    /**
     * Static representation of the [[lastModifiedDateTime]] property for query construction.
     * Use to reference this property in query operations such as 'select' in the fluent request API.
     */
    PerPerson.LAST_MODIFIED_DATE_TIME = new core_1.DateField('lastModifiedDateTime', PerPerson, 'Edm.DateTimeOffset');
    /**
     * Static representation of the [[lastModifiedOn]] property for query construction.
     * Use to reference this property in query operations such as 'select' in the fluent request API.
     */
    PerPerson.LAST_MODIFIED_ON = new core_1.DateField('lastModifiedOn', PerPerson, 'Edm.DateTime');
    /**
     * Static representation of the [[perPersonUuid]] property for query construction.
     * Use to reference this property in query operations such as 'select' in the fluent request API.
     */
    PerPerson.PER_PERSON_UUID = new core_1.StringField('perPersonUuid', PerPerson, 'Edm.String');
    /**
     * Static representation of the [[personId]] property for query construction.
     * Use to reference this property in query operations such as 'select' in the fluent request API.
     */
    PerPerson.PERSON_ID = new core_1.BigNumberField('personId', PerPerson, 'Edm.Int64');
    /**
     * Static representation of the [[personIdExternal]] property for query construction.
     * Use to reference this property in query operations such as 'select' in the fluent request API.
     */
    PerPerson.PERSON_ID_EXTERNAL = new core_1.StringField('personIdExternal', PerPerson, 'Edm.String');
    /**
     * Static representation of the [[placeOfBirth]] property for query construction.
     * Use to reference this property in query operations such as 'select' in the fluent request API.
     */
    PerPerson.PLACE_OF_BIRTH = new core_1.StringField('placeOfBirth', PerPerson, 'Edm.String');
    /**
     * Static representation of the [[regionOfBirth]] property for query construction.
     * Use to reference this property in query operations such as 'select' in the fluent request API.
     */
    PerPerson.REGION_OF_BIRTH = new core_1.StringField('regionOfBirth', PerPerson, 'Edm.String');
    /**
     * Static representation of the [[userId]] property for query construction.
     * Use to reference this property in query operations such as 'select' in the fluent request API.
     */
    PerPerson.USER_ID = new core_1.StringField('userId', PerPerson, 'Edm.String');
    /**
     * Static representation of the one-to-one navigation property [[countryOfBirthNav]] for query construction.
     * Use to reference this property in query operations such as 'select' in the fluent request API.
     */
    PerPerson.COUNTRY_OF_BIRTH_NAV = new core_1.OneToOneLink('countryOfBirthNav', PerPerson, Territory_1.Territory);
    /**
     * Static representation of the one-to-many navigation property [[emailNav]] for query construction.
     * Use to reference this property in query operations such as 'select' in the fluent request API.
     */
    PerPerson.EMAIL_NAV = new core_1.Link('emailNav', PerPerson, PerEmail_1.PerEmail);
    /**
     * Static representation of the one-to-many navigation property [[emergencyContactNav]] for query construction.
     * Use to reference this property in query operations such as 'select' in the fluent request API.
     */
    PerPerson.EMERGENCY_CONTACT_NAV = new core_1.Link('emergencyContactNav', PerPerson, PerEmergencyContacts_1.PerEmergencyContacts);
    /**
     * Static representation of the one-to-many navigation property [[employmentNav]] for query construction.
     * Use to reference this property in query operations such as 'select' in the fluent request API.
     */
    PerPerson.EMPLOYMENT_NAV = new core_1.Link('employmentNav', PerPerson, EmpEmployment_1.EmpEmployment);
    /**
     * Static representation of the one-to-many navigation property [[homeAddressNavDeflt]] for query construction.
     * Use to reference this property in query operations such as 'select' in the fluent request API.
     */
    PerPerson.HOME_ADDRESS_NAV_DEFLT = new core_1.Link('homeAddressNavDEFLT', PerPerson, PerAddressDeflt_1.PerAddressDeflt);
    /**
     * Static representation of the one-to-many navigation property [[nationalIdNav]] for query construction.
     * Use to reference this property in query operations such as 'select' in the fluent request API.
     */
    PerPerson.NATIONAL_ID_NAV = new core_1.Link('nationalIdNav', PerPerson, PerNationalId_1.PerNationalId);
    /**
     * Static representation of the one-to-one navigation property [[personEmpTerminationInfoNav]] for query construction.
     * Use to reference this property in query operations such as 'select' in the fluent request API.
     */
    PerPerson.PERSON_EMP_TERMINATION_INFO_NAV = new core_1.OneToOneLink('personEmpTerminationInfoNav', PerPerson, PersonEmpTerminationInfo_1.PersonEmpTerminationInfo);
    /**
     * Static representation of the one-to-many navigation property [[personRerlationshipNav]] for query construction.
     * Use to reference this property in query operations such as 'select' in the fluent request API.
     */
    PerPerson.PERSON_RERLATIONSHIP_NAV = new core_1.Link('personRerlationshipNav', PerPerson, PerPersonRelationship_1.PerPersonRelationship);
    /**
     * Static representation of the one-to-one navigation property [[personTypeUsageNav]] for query construction.
     * Use to reference this property in query operations such as 'select' in the fluent request API.
     */
    PerPerson.PERSON_TYPE_USAGE_NAV = new core_1.OneToOneLink('personTypeUsageNav', PerPerson, PersonTypeUsage_1.PersonTypeUsage);
    /**
     * Static representation of the one-to-many navigation property [[personalInfoNav]] for query construction.
     * Use to reference this property in query operations such as 'select' in the fluent request API.
     */
    PerPerson.PERSONAL_INFO_NAV = new core_1.Link('personalInfoNav', PerPerson, PerPersonal_1.PerPersonal);
    /**
     * Static representation of the one-to-many navigation property [[phoneNav]] for query construction.
     * Use to reference this property in query operations such as 'select' in the fluent request API.
     */
    PerPerson.PHONE_NAV = new core_1.Link('phoneNav', PerPerson, PerPhone_1.PerPhone);
    /**
     * Static representation of the one-to-one navigation property [[userAccountNav]] for query construction.
     * Use to reference this property in query operations such as 'select' in the fluent request API.
     */
    PerPerson.USER_ACCOUNT_NAV = new core_1.OneToOneLink('userAccountNav', PerPerson, UserAccount_1.UserAccount);
    /**
     ...
     * All fields selector.
     */
    PerPerson.ALL_FIELDS = new core_1.AllFields('*', PerPerson);
    /**
