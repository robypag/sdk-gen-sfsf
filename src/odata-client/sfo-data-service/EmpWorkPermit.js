...
var EmpWorkPermit = /** @class */ (function (_super) {
    ...
    EmpWorkPermit.builder = function () {
        return core_1.Entity.entityBuilder(EmpWorkPermit);
    };
    /**
    ...
    EmpWorkPermit.customField = function (fieldName) {
        return core_1.Entity.customFieldSelector(fieldName, EmpWorkPermit);
    };
    /**
     ...
     */
    EmpWorkPermit._defaultServicePath = 'VALUE_IS_UNDEFINED';
...
(function (EmpWorkPermit) {
     ...
     */
    EmpWorkPermit.ATTACHMENT = new core_1.BinaryField('attachment', EmpWorkPermit, 'Edm.Binary');
    /**
     * Static representation of the [[attachmentFileName]] property for query construction.
     * Use to reference this property in query operations such as 'select' in the fluent request API.
     */
    EmpWorkPermit.ATTACHMENT_FILE_NAME = new core_1.StringField('attachmentFileName', EmpWorkPermit, 'Edm.String');
    /**
     * Static representation of the [[attachmentFileSize]] property for query construction.
     * Use to reference this property in query operations such as 'select' in the fluent request API.
     */
    EmpWorkPermit.ATTACHMENT_FILE_SIZE = new core_1.BigNumberField('attachmentFileSize', EmpWorkPermit, 'Edm.Decimal');
    /**
     * Static representation of the [[attachmentFileType]] property for query construction.
     * Use to reference this property in query operations such as 'select' in the fluent request API.
     */
    EmpWorkPermit.ATTACHMENT_FILE_TYPE = new core_1.StringField('attachmentFileType', EmpWorkPermit, 'Edm.String');
    /**
     * Static representation of the [[attachmentId]] property for query construction.
     * Use to reference this property in query operations such as 'select' in the fluent request API.
     */
    EmpWorkPermit.ATTACHMENT_ID = new core_1.StringField('attachmentId', EmpWorkPermit, 'Edm.String');
    /**
     * Static representation of the [[attachmentMimeType]] property for query construction.
     * Use to reference this property in query operations such as 'select' in the fluent request API.
     */
    EmpWorkPermit.ATTACHMENT_MIME_TYPE = new core_1.StringField('attachmentMimeType', EmpWorkPermit, 'Edm.String');
    /**
     * Static representation of the [[attachmentStatus]] property for query construction.
     * Use to reference this property in query operations such as 'select' in the fluent request API.
     */
    EmpWorkPermit.ATTACHMENT_STATUS = new core_1.BigNumberField('attachmentStatus', EmpWorkPermit, 'Edm.Decimal');
    /**
     * Static representation of the [[country]] property for query construction.
     * Use to reference this property in query operations such as 'select' in the fluent request API.
     */
    EmpWorkPermit.COUNTRY = new core_1.StringField('country', EmpWorkPermit, 'Edm.String');
    /**
     * Static representation of the [[createdBy]] property for query construction.
     * Use to reference this property in query operations such as 'select' in the fluent request API.
     */
    EmpWorkPermit.CREATED_BY = new core_1.StringField('createdBy', EmpWorkPermit, 'Edm.String');
    /**
     * Static representation of the [[createdDateTime]] property for query construction.
     * Use to reference this property in query operations such as 'select' in the fluent request API.
     */
    EmpWorkPermit.CREATED_DATE_TIME = new core_1.DateField('createdDateTime', EmpWorkPermit, 'Edm.DateTimeOffset');
    /**
     * Static representation of the [[createdOn]] property for query construction.
     * Use to reference this property in query operations such as 'select' in the fluent request API.
     */
    EmpWorkPermit.CREATED_ON = new core_1.DateField('createdOn', EmpWorkPermit, 'Edm.DateTime');
    /**
     * Static representation of the [[documentNumber]] property for query construction.
     * Use to reference this property in query operations such as 'select' in the fluent request API.
     */
    EmpWorkPermit.DOCUMENT_NUMBER = new core_1.StringField('documentNumber', EmpWorkPermit, 'Edm.String');
    /**
     * Static representation of the [[documentTitle]] property for query construction.
     * Use to reference this property in query operations such as 'select' in the fluent request API.
     */
    EmpWorkPermit.DOCUMENT_TITLE = new core_1.StringField('documentTitle', EmpWorkPermit, 'Edm.String');
    /**
     * Static representation of the [[documentType]] property for query construction.
     * Use to reference this property in query operations such as 'select' in the fluent request API.
     */
    EmpWorkPermit.DOCUMENT_TYPE = new core_1.StringField('documentType', EmpWorkPermit, 'Edm.String');
    /**
     * Static representation of the [[expirationDate]] property for query construction.
     * Use to reference this property in query operations such as 'select' in the fluent request API.
     */
    EmpWorkPermit.EXPIRATION_DATE = new core_1.DateField('expirationDate', EmpWorkPermit, 'Edm.DateTime');
    /**
     * Static representation of the [[isValidated]] property for query construction.
     * Use to reference this property in query operations such as 'select' in the fluent request API.
     */
    EmpWorkPermit.IS_VALIDATED = new core_1.BooleanField('isValidated', EmpWorkPermit, 'Edm.Boolean');
    /**
     * Static representation of the [[issueDate]] property for query construction.
     * Use to reference this property in query operations such as 'select' in the fluent request API.
     */
    EmpWorkPermit.ISSUE_DATE = new core_1.DateField('issueDate', EmpWorkPermit, 'Edm.DateTime');
    /**
     * Static representation of the [[issuePlace]] property for query construction.
     * Use to reference this property in query operations such as 'select' in the fluent request API.
     */
    EmpWorkPermit.ISSUE_PLACE = new core_1.StringField('issuePlace', EmpWorkPermit, 'Edm.String');
    /**
     * Static representation of the [[issuingAuthority]] property for query construction.
     * Use to reference this property in query operations such as 'select' in the fluent request API.
     */
    EmpWorkPermit.ISSUING_AUTHORITY = new core_1.StringField('issuingAuthority', EmpWorkPermit, 'Edm.String');
    /**
     * Static representation of the [[lastModifiedBy]] property for query construction.
     * Use to reference this property in query operations such as 'select' in the fluent request API.
     */
    EmpWorkPermit.LAST_MODIFIED_BY = new core_1.StringField('lastModifiedBy', EmpWorkPermit, 'Edm.String');
    /**
     * Static representation of the [[lastModifiedDateTime]] property for query construction.
     * Use to reference this property in query operations such as 'select' in the fluent request API.
     */
    EmpWorkPermit.LAST_MODIFIED_DATE_TIME = new core_1.DateField('lastModifiedDateTime', EmpWorkPermit, 'Edm.DateTimeOffset');
    /**
     * Static representation of the [[lastModifiedOn]] property for query construction.
     * Use to reference this property in query operations such as 'select' in the fluent request API.
     */
    EmpWorkPermit.LAST_MODIFIED_ON = new core_1.DateField('lastModifiedOn', EmpWorkPermit, 'Edm.DateTime');
    /**
     * Static representation of the [[notes]] property for query construction.
     * Use to reference this property in query operations such as 'select' in the fluent request API.
     */
    EmpWorkPermit.NOTES = new core_1.StringField('notes', EmpWorkPermit, 'Edm.String');
    /**
     * Static representation of the [[userId]] property for query construction.
     * Use to reference this property in query operations such as 'select' in the fluent request API.
     */
    EmpWorkPermit.USER_ID = new core_1.StringField('userId', EmpWorkPermit, 'Edm.String');
    /**
     * Static representation of the one-to-one navigation property [[countryNav]] for query construction.
     * Use to reference this property in query operations such as 'select' in the fluent request API.
     */
    EmpWorkPermit.COUNTRY_NAV = new core_1.OneToOneLink('countryNav', EmpWorkPermit, PicklistOption_1.PicklistOption);
    /**
     * Static representation of the one-to-one navigation property [[employmentNav]] for query construction.
     * Use to reference this property in query operations such as 'select' in the fluent request API.
     */
    EmpWorkPermit.EMPLOYMENT_NAV = new core_1.OneToOneLink('employmentNav', EmpWorkPermit, EmpEmployment_1.EmpEmployment);
    /**
     * Static representation of the one-to-one navigation property [[userNav]] for query construction.
     * Use to reference this property in query operations such as 'select' in the fluent request API.
     */
    EmpWorkPermit.USER_NAV = new core_1.OneToOneLink('userNav', EmpWorkPermit, User_1.User);
    /**
    ...
    EmpWorkPermit._allFields = [
        ...
        EmpWorkPermit.COUNTRY_NAV,
        EmpWorkPermit.EMPLOYMENT_NAV,
        EmpWorkPermit.USER_NAV
    ];
    /**
     * All fields selector.
     */
    EmpWorkPermit.ALL_FIELDS = new core_1.AllFields('*', EmpWorkPermit);
    /**
