...
var JobApplicationSnapshot_InsideWorkExperienceRequestBuilder = /** @class */ (function (_super) {
    ...
    JobApplicationSnapshot_InsideWorkExperienceRequestBuilder.prototype.getByKey = function (backgroundElementId) {
        return new core_1.GetByKeyRequestBuilder(JobApplicationSnapshot_InsideWorkExperience_1.JobApplicationSnapshot_InsideWorkExperience, { backgroundElementId: backgroundElementId });
    };
    /**
    ...
    JobApplicationSnapshot_InsideWorkExperienceRequestBuilder.prototype.getAll = function () {
        return new core_1.GetAllRequestBuilder(JobApplicationSnapshot_InsideWorkExperience_1.JobApplicationSnapshot_InsideWorkExperience);
    };
