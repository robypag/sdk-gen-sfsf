 ...
 */
export class FoBusinessUnitRequestBuilder extends RequestBuilder<FoBusinessUnit> {
  /**
  ...
  getByKey(externalCode: string, startDate: Moment): GetByKeyRequestBuilder<FoBusinessUnit> {
    return new GetByKeyRequestBuilder(FoBusinessUnit, {
  ...
  getAll(): GetAllRequestBuilder<FoBusinessUnit> {
    return new GetAllRequestBuilder(FoBusinessUnit);
  }
  ...
  create(entity: FoBusinessUnit): CreateRequestBuilder<FoBusinessUnit> {
    return new CreateRequestBuilder(FoBusinessUnit, entity);
  }
  ...
  update(entity: FoBusinessUnit): UpdateRequestBuilder<FoBusinessUnit> {
    return new UpdateRequestBuilder(FoBusinessUnit, entity);
  }
  ...
  delete(externalCodeOrEntity: any, startDate?: Moment): DeleteRequestBuilder<FoBusinessUnit> {
    return new DeleteRequestBuilder(FoBusinessUnit, externalCodeOrEntity instanceof FoBusinessUnit ? externalCodeOrEntity : {
