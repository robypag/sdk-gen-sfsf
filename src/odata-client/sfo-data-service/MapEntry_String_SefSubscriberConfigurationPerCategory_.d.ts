 ...
 */
export declare function createMapEntry_String_SefSubscriberConfigurationPerCategory_(json: any): MapEntry_String_SefSubscriberConfigurationPerCategory_;
/**
 * MapEntry_String_SefSubscriberConfigurationPerCategory_Field
 * @typeparam EntityT - Type of the entity the complex type field belongs to.
 */
export declare class MapEntry_String_SefSubscriberConfigurationPerCategory_Field<EntityT extends Entity> extends ComplexTypeField<EntityT> {
    /**
...
export declare namespace MapEntry_String_SefSubscriberConfigurationPerCategory_ {
    function build(json: {
        [keys: string]: FieldType;
    }): MapEntry_String_SefSubscriberConfigurationPerCategory_;
}
//# sourceMappingURL=MapEntry_String_SefSubscriberConfigurationPerCategory_.d.ts.map