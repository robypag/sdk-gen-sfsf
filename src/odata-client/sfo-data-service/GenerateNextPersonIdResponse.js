...
var GenerateNextPersonIdResponseField = /** @class */ (function (_super) {
    ...
    function GenerateNextPersonIdResponseField() {
         ...
         */
        _this.personId = new core_1.ComplexTypeStringPropertyField('personID', _this, 'Edm.String');
        return _this;
    }
...
(function (GenerateNextPersonIdResponse) {
    function build(json) {
        return core_1.createComplexType(json, {
            personID: function (personId) { return ({ personId: core_1.edmToTs(personId, 'Edm.String') }); }
        });
    }
