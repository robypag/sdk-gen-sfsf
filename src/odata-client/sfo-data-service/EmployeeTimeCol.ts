...
export namespace EmployeeTimeCol {
   ...
   * Use to reference this property in query operations such as 'select' in the fluent request API.
   */
  export const CREATED_BY_NAV: OneToOneLink<EmployeeTimeCol, User> = new OneToOneLink('createdByNav', EmployeeTimeCol, User);
  /**
   ...
   * Use to reference this property in query operations such as 'select' in the fluent request API.
   */
  export const LAST_MODIFIED_BY_NAV: OneToOneLink<EmployeeTimeCol, User> = new OneToOneLink('lastModifiedByNav', EmployeeTimeCol, User);
  /**
   * Static representation of the one-to-one navigation property [[mdfSystemRecordStatusNav]] for query construction.
   * Use to reference this property in query operations such as 'select' in the fluent request API.
   */
  export const MDF_SYSTEM_RECORD_STATUS_NAV: OneToOneLink<EmployeeTimeCol, MdfEnumValue> = new OneToOneLink('mdfSystemRecordStatusNav', EmployeeTimeCol, MdfEnumValue);
  /**
   * All fields of the EmployeeTimeCol entity.
   */
  export const _allFields: Array<StringField<EmployeeTimeCol> | DateField<EmployeeTimeCol> | BigNumberField<EmployeeTimeCol> | OneToOneLink<EmployeeTimeCol, User> | OneToOneLink<EmployeeTimeCol, EmployeeTimeGroup> | OneToOneLink<EmployeeTimeCol, MdfEnumValue>> = [
    ...
    EmployeeTimeCol.CREATED_BY_NAV,
    EmployeeTimeCol.IDENTICAL_SICKNESS_GROUP_NAV,
    EmployeeTimeCol.LAST_MODIFIED_BY_NAV,
    EmployeeTimeCol.MDF_SYSTEM_RECORD_STATUS_NAV
  ];
  /**
   * All fields selector.
   */
