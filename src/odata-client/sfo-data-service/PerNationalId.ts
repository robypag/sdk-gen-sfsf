...
export namespace PerNationalId {
   ...
   * Use to reference this property in query operations such as 'select' in the fluent request API.
   */
  export const COUNTRY_NAV: OneToOneLink<PerNationalId, Territory> = new OneToOneLink('countryNav', PerNationalId, Territory);
  /**
   ...
   */
  export const _allFields: Array<StringField<PerNationalId> | DateField<PerNationalId> | BooleanField<PerNationalId> | OneToOneLink<PerNationalId, Territory> | OneToOneLink<PerNationalId, PerPerson>> = [
