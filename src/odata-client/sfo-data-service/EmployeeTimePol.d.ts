...
export declare namespace EmployeeTimePol {
     ...
     * Use to reference this property in query operations such as 'select' in the fluent request API.
     */
    const CREATED_BY_NAV: OneToOneLink<EmployeeTimePol, User>;
    /**
     * Static representation of the one-to-one navigation property [[lastModifiedByNav]] for query construction.
     * Use to reference this property in query operations such as 'select' in the fluent request API.
     */
    const LAST_MODIFIED_BY_NAV: OneToOneLink<EmployeeTimePol, User>;
    /**
     * Static representation of the one-to-one navigation property [[mdfSystemRecordStatusNav]] for query construction.
     * Use to reference this property in query operations such as 'select' in the fluent request API.
     */
    const MDF_SYSTEM_RECORD_STATUS_NAV: OneToOneLink<EmployeeTimePol, MdfEnumValue>;
    /**
     * All fields of the EmployeeTimePol entity.
     */
    const _allFields: Array<StringField<EmployeeTimePol> | DateField<EmployeeTimePol> | BigNumberField<EmployeeTimePol> | OneToOneLink<EmployeeTimePol, User> | OneToOneLink<EmployeeTimePol, MdfEnumValue>>;
    /**
     * All fields selector.
     */
