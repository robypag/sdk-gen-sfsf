...
export namespace EmployeeTimeMex {
   ...
   * Use to reference this property in query operations such as 'select' in the fluent request API.
   */
  export const CREATED_BY_NAV: OneToOneLink<EmployeeTimeMex, User> = new OneToOneLink('createdByNav', EmployeeTimeMex, User);
  /**
   ...
   * Use to reference this property in query operations such as 'select' in the fluent request API.
   */
  export const LAST_MODIFIED_BY_NAV: OneToOneLink<EmployeeTimeMex, User> = new OneToOneLink('lastModifiedByNav', EmployeeTimeMex, User);
  /**
   * Static representation of the one-to-one navigation property [[mdfSystemRecordStatusNav]] for query construction.
   * Use to reference this property in query operations such as 'select' in the fluent request API.
   */
  export const MDF_SYSTEM_RECORD_STATUS_NAV: OneToOneLink<EmployeeTimeMex, MdfEnumValue> = new OneToOneLink('mdfSystemRecordStatusNav', EmployeeTimeMex, MdfEnumValue);
  /**
   * All fields of the EmployeeTimeMex entity.
   */
  export const _allFields: Array<StringField<EmployeeTimeMex> | DateField<EmployeeTimeMex> | BigNumberField<EmployeeTimeMex> | OneToOneLink<EmployeeTimeMex, User> | OneToOneLink<EmployeeTimeMex, EmployeeTimeGroup> | OneToOneLink<EmployeeTimeMex, MdfEnumValue>> = [
    ...
    EmployeeTimeMex.CREATED_BY_NAV,
    EmployeeTimeMex.IDENTICAL_SICKNESS_GROUP_NAV,
    EmployeeTimeMex.LAST_MODIFIED_BY_NAV,
    EmployeeTimeMex.MDF_SYSTEM_RECORD_STATUS_NAV
  ];
  /**
   * All fields selector.
   */
