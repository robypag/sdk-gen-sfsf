 ...
 */
export class PerGlobalInfoMexRequestBuilder extends RequestBuilder<PerGlobalInfoMex> {
  /**
  ...
  getByKey(country: string, personIdExternal: string, startDate: Moment): GetByKeyRequestBuilder<PerGlobalInfoMex> {
    return new GetByKeyRequestBuilder(PerGlobalInfoMex, {
      country: country,
  ...
  getAll(): GetAllRequestBuilder<PerGlobalInfoMex> {
    return new GetAllRequestBuilder(PerGlobalInfoMex);
  }
}
