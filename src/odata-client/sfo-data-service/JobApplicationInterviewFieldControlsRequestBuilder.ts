 ...
 */
export class JobApplicationInterviewFieldControlsRequestBuilder extends RequestBuilder<JobApplicationInterviewFieldControls> {
  /**
  ...
  getByKey(applicationInterviewId: number): GetByKeyRequestBuilder<JobApplicationInterviewFieldControls> {
    return new GetByKeyRequestBuilder(JobApplicationInterviewFieldControls, { applicationInterviewId: applicationInterviewId });
  }
  ...
  getAll(): GetAllRequestBuilder<JobApplicationInterviewFieldControls> {
    return new GetAllRequestBuilder(JobApplicationInterviewFieldControls);
  }
}
