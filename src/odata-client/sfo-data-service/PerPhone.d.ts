...
export declare namespace PerPhone {
     ...
     * Use to reference this property in query operations such as 'select' in the fluent request API.
     */
    const PHONE_TYPE_NAV: OneToOneLink<PerPhone, PicklistOption>;
    /**
     * All fields of the PerPhone entity.
     */
    const _allFields: Array<StringField<PerPhone> | DateField<PerPhone> | BooleanField<PerPhone> | OneToOneLink<PerPhone, PerPerson> | OneToOneLink<PerPhone, PicklistOption>>;
    /**
     * All fields selector.
     */
