...
export declare namespace PerEmail {
     ...
     * Use to reference this property in query operations such as 'select' in the fluent request API.
     */
    const EMAIL_TYPE_NAV: OneToOneLink<PerEmail, PicklistOption>;
    /**
     ...
     */
    const _allFields: Array<StringField<PerEmail> | DateField<PerEmail> | BooleanField<PerEmail> | OneToOneLink<PerEmail, PicklistOption> | OneToOneLink<PerEmail, PerPerson>>;
    /**
     * All fields selector.
     */
