...
export namespace EmpWorkPermit {
   ...
   * Use to reference this property in query operations such as 'select' in the fluent request API.
   */
  export const COUNTRY_NAV: OneToOneLink<EmpWorkPermit, PicklistOption> = new OneToOneLink('countryNav', EmpWorkPermit, PicklistOption);
  /**
   ...
   * Use to reference this property in query operations such as 'select' in the fluent request API.
   */
  export const USER_NAV: OneToOneLink<EmpWorkPermit, User> = new OneToOneLink('userNav', EmpWorkPermit, User);
  /**
   * All fields of the EmpWorkPermit entity.
   */
  export const _allFields: Array<BinaryField<EmpWorkPermit> | StringField<EmpWorkPermit> | BigNumberField<EmpWorkPermit> | DateField<EmpWorkPermit> | BooleanField<EmpWorkPermit> | OneToOneLink<EmpWorkPermit, PicklistOption> | OneToOneLink<EmpWorkPermit, EmpEmployment> | OneToOneLink<EmpWorkPermit, User>> = [
