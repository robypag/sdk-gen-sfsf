...
export declare namespace EmpWorkPermit {
     ...
     * Use to reference this property in query operations such as 'select' in the fluent request API.
     */
    const COUNTRY_NAV: OneToOneLink<EmpWorkPermit, PicklistOption>;
    /**
     ...
     * Use to reference this property in query operations such as 'select' in the fluent request API.
     */
    const USER_NAV: OneToOneLink<EmpWorkPermit, User>;
    /**
     * All fields of the EmpWorkPermit entity.
     */
    const _allFields: Array<BinaryField<EmpWorkPermit> | StringField<EmpWorkPermit> | BigNumberField<EmpWorkPermit> | DateField<EmpWorkPermit> | BooleanField<EmpWorkPermit> | OneToOneLink<EmpWorkPermit, PicklistOption> | OneToOneLink<EmpWorkPermit, EmpEmployment> | OneToOneLink<EmpWorkPermit, User>>;
    /**
     * All fields selector.
     */
