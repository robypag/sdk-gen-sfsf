 ...
 */
export class VendorInfoRequestBuilder extends RequestBuilder<VendorInfo> {
  /**
  ...
  getByKey(effectiveStartDate: Moment, vendorCode: string): GetByKeyRequestBuilder<VendorInfo> {
    return new GetByKeyRequestBuilder(VendorInfo, {
  ...
  getAll(): GetAllRequestBuilder<VendorInfo> {
    return new GetAllRequestBuilder(VendorInfo);
  }
  ...
  create(entity: VendorInfo): CreateRequestBuilder<VendorInfo> {
    return new CreateRequestBuilder(VendorInfo, entity);
  }
  ...
  update(entity: VendorInfo): UpdateRequestBuilder<VendorInfo> {
    return new UpdateRequestBuilder(VendorInfo, entity);
  }
  ...
  delete(effectiveStartDateOrEntity: any, vendorCode?: string): DeleteRequestBuilder<VendorInfo> {
    return new DeleteRequestBuilder(VendorInfo, effectiveStartDateOrEntity instanceof VendorInfo ? effectiveStartDateOrEntity : {
