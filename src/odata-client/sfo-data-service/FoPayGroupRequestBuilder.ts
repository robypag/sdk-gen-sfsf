 ...
 */
export class FoPayGroupRequestBuilder extends RequestBuilder<FoPayGroup> {
  /**
  ...
  getByKey(externalCode: string, startDate: Moment): GetByKeyRequestBuilder<FoPayGroup> {
    return new GetByKeyRequestBuilder(FoPayGroup, {
  ...
  getAll(): GetAllRequestBuilder<FoPayGroup> {
    return new GetAllRequestBuilder(FoPayGroup);
  }
  ...
  create(entity: FoPayGroup): CreateRequestBuilder<FoPayGroup> {
    return new CreateRequestBuilder(FoPayGroup, entity);
  }
  ...
  update(entity: FoPayGroup): UpdateRequestBuilder<FoPayGroup> {
    return new UpdateRequestBuilder(FoPayGroup, entity);
  }
  ...
  delete(externalCodeOrEntity: any, startDate?: Moment): DeleteRequestBuilder<FoPayGroup> {
    return new DeleteRequestBuilder(FoPayGroup, externalCodeOrEntity instanceof FoPayGroup ? externalCodeOrEntity : {
