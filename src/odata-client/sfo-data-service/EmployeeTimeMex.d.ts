...
export declare namespace EmployeeTimeMex {
     ...
     * Use to reference this property in query operations such as 'select' in the fluent request API.
     */
    const CREATED_BY_NAV: OneToOneLink<EmployeeTimeMex, User>;
    /**
     ...
     * Use to reference this property in query operations such as 'select' in the fluent request API.
     */
    const LAST_MODIFIED_BY_NAV: OneToOneLink<EmployeeTimeMex, User>;
    /**
     * Static representation of the one-to-one navigation property [[mdfSystemRecordStatusNav]] for query construction.
     * Use to reference this property in query operations such as 'select' in the fluent request API.
     */
    const MDF_SYSTEM_RECORD_STATUS_NAV: OneToOneLink<EmployeeTimeMex, MdfEnumValue>;
    /**
     * All fields of the EmployeeTimeMex entity.
     */
    const _allFields: Array<StringField<EmployeeTimeMex> | DateField<EmployeeTimeMex> | BigNumberField<EmployeeTimeMex> | OneToOneLink<EmployeeTimeMex, User> | OneToOneLink<EmployeeTimeMex, EmployeeTimeGroup> | OneToOneLink<EmployeeTimeMex, MdfEnumValue>>;
    /**
     * All fields selector.
     */
