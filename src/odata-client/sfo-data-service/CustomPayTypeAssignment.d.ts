 ...
 */
export declare class CustomPayTypeAssignment extends Entity implements CustomPayTypeAssignmentType {
    /**
...
export declare namespace CustomPayTypeAssignment {
    /**
     * Static representation of the [[customPayTypeExternalCode]] property for query construction.
     * Use to reference this property in query operations such as 'select' in the fluent request API.
     */
    const CUSTOM_PAY_TYPE_EXTERNAL_CODE: StringField<CustomPayTypeAssignment>;
    /**
     * Static representation of the [[country]] property for query construction.
     * Use to reference this property in query operations such as 'select' in the fluent request API.
     */
    const COUNTRY: StringField<CustomPayTypeAssignment>;
    /**
     * Static representation of the [[createdBy]] property for query construction.
     * Use to reference this property in query operations such as 'select' in the fluent request API.
     */
    const CREATED_BY: StringField<CustomPayTypeAssignment>;
    /**
     * Static representation of the [[createdDateTime]] property for query construction.
     * Use to reference this property in query operations such as 'select' in the fluent request API.
     */
    const CREATED_DATE_TIME: DateField<CustomPayTypeAssignment>;
    /**
     * Static representation of the [[externalCode]] property for query construction.
     * Use to reference this property in query operations such as 'select' in the fluent request API.
     */
    const EXTERNAL_CODE: BigNumberField<CustomPayTypeAssignment>;
    /**
     * Static representation of the [[lastModifiedBy]] property for query construction.
     * Use to reference this property in query operations such as 'select' in the fluent request API.
     */
    const LAST_MODIFIED_BY: StringField<CustomPayTypeAssignment>;
    /**
     * Static representation of the [[lastModifiedDateTime]] property for query construction.
     * Use to reference this property in query operations such as 'select' in the fluent request API.
     */
    const LAST_MODIFIED_DATE_TIME: DateField<CustomPayTypeAssignment>;
    /**
     * Static representation of the [[mdfSystemRecordStatus]] property for query construction.
     * Use to reference this property in query operations such as 'select' in the fluent request API.
     */
    const MDF_SYSTEM_RECORD_STATUS: StringField<CustomPayTypeAssignment>;
    /**
     * Static representation of the one-to-many navigation property [[countryNav]] for query construction.
     * Use to reference this property in query operations such as 'select' in the fluent request API.
     */
    const COUNTRY_NAV: Link<CustomPayTypeAssignment, Country>;
    /**
     * Static representation of the one-to-one navigation property [[createdByNav]] for query construction.
     * Use to reference this property in query operations such as 'select' in the fluent request API.
     */
    const CREATED_BY_NAV: OneToOneLink<CustomPayTypeAssignment, User>;
    /**
     * Static representation of the one-to-one navigation property [[lastModifiedByNav]] for query construction.
     * Use to reference this property in query operations such as 'select' in the fluent request API.
     */
    const LAST_MODIFIED_BY_NAV: OneToOneLink<CustomPayTypeAssignment, User>;
    /**
     * Static representation of the one-to-one navigation property [[mdfSystemRecordStatusNav]] for query construction.
     * Use to reference this property in query operations such as 'select' in the fluent request API.
     */
    const MDF_SYSTEM_RECORD_STATUS_NAV: OneToOneLink<CustomPayTypeAssignment, MdfEnumValue>;
    /**
     * All fields of the CustomPayTypeAssignment entity.
     */
    const _allFields: Array<StringField<CustomPayTypeAssignment> | DateField<CustomPayTypeAssignment> | BigNumberField<CustomPayTypeAssignment> | Link<CustomPayTypeAssignment, Country> | OneToOneLink<CustomPayTypeAssignment, User> | OneToOneLink<CustomPayTypeAssignment, MdfEnumValue>>;
    /**
     * All fields selector.
     */
    const ALL_FIELDS: AllFields<CustomPayTypeAssignment>;
    /**
     * All key fields of the CustomPayTypeAssignment entity.
     */
    const _keyFields: Array<Selectable<CustomPayTypeAssignment>>;
    /**
     * Mapping of all key field names to the respective static field property CustomPayTypeAssignment.
     */
    const _keys: {
        [keys: string]: Selectable<CustomPayTypeAssignment>;
    };
}
//# sourceMappingURL=CustomPayTypeAssignment.d.ts.map