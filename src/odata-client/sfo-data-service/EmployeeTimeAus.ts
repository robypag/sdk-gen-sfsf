...
export namespace EmployeeTimeAus {
   ...
   * Use to reference this property in query operations such as 'select' in the fluent request API.
   */
  export const CREATED_BY_NAV: OneToOneLink<EmployeeTimeAus, User> = new OneToOneLink('createdByNav', EmployeeTimeAus, User);
  /**
   * Static representation of the one-to-one navigation property [[lastModifiedByNav]] for query construction.
   * Use to reference this property in query operations such as 'select' in the fluent request API.
   */
  export const LAST_MODIFIED_BY_NAV: OneToOneLink<EmployeeTimeAus, User> = new OneToOneLink('lastModifiedByNav', EmployeeTimeAus, User);
  /**
   * Static representation of the one-to-one navigation property [[mdfSystemRecordStatusNav]] for query construction.
   * Use to reference this property in query operations such as 'select' in the fluent request API.
   */
  export const MDF_SYSTEM_RECORD_STATUS_NAV: OneToOneLink<EmployeeTimeAus, MdfEnumValue> = new OneToOneLink('mdfSystemRecordStatusNav', EmployeeTimeAus, MdfEnumValue);
  /**
   * All fields of the EmployeeTimeAus entity.
   */
  export const _allFields: Array<StringField<EmployeeTimeAus> | DateField<EmployeeTimeAus> | BigNumberField<EmployeeTimeAus> | BooleanField<EmployeeTimeAus> | OneToOneLink<EmployeeTimeAus, User> | OneToOneLink<EmployeeTimeAus, MdfEnumValue>> = [
    ...
    EmployeeTimeAus.CREATED_BY_NAV,
    EmployeeTimeAus.LAST_MODIFIED_BY_NAV,
    EmployeeTimeAus.MDF_SYSTEM_RECORD_STATUS_NAV
  ];
  /**
   * All fields selector.
   */
