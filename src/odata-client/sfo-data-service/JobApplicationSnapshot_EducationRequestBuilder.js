...
var JobApplicationSnapshot_EducationRequestBuilder = /** @class */ (function (_super) {
    ...
    JobApplicationSnapshot_EducationRequestBuilder.prototype.getByKey = function (backgroundElementId) {
        return new core_1.GetByKeyRequestBuilder(JobApplicationSnapshot_Education_1.JobApplicationSnapshot_Education, { backgroundElementId: backgroundElementId });
    };
    /**
    ...
    JobApplicationSnapshot_EducationRequestBuilder.prototype.getAll = function () {
        return new core_1.GetAllRequestBuilder(JobApplicationSnapshot_Education_1.JobApplicationSnapshot_Education);
    };
