...
export namespace TimeTypeAus {
   ...
   * Use to reference this property in query operations such as 'select' in the fluent request API.
   */
  export const CREATED_BY_NAV: OneToOneLink<TimeTypeAus, User> = new OneToOneLink('createdByNav', TimeTypeAus, User);
  /**
   * Static representation of the one-to-one navigation property [[lastModifiedByNav]] for query construction.
   * Use to reference this property in query operations such as 'select' in the fluent request API.
   */
  export const LAST_MODIFIED_BY_NAV: OneToOneLink<TimeTypeAus, User> = new OneToOneLink('lastModifiedByNav', TimeTypeAus, User);
  /**
   * Static representation of the one-to-one navigation property [[mdfSystemRecordStatusNav]] for query construction.
   * Use to reference this property in query operations such as 'select' in the fluent request API.
   */
  export const MDF_SYSTEM_RECORD_STATUS_NAV: OneToOneLink<TimeTypeAus, MdfEnumValue> = new OneToOneLink('mdfSystemRecordStatusNav', TimeTypeAus, MdfEnumValue);
  /**
   * All fields of the TimeTypeAus entity.
   */
  export const _allFields: Array<StringField<TimeTypeAus> | BooleanField<TimeTypeAus> | DateField<TimeTypeAus> | BigNumberField<TimeTypeAus> | OneToOneLink<TimeTypeAus, User> | OneToOneLink<TimeTypeAus, MdfEnumValue>> = [
    ...
    TimeTypeAus.CREATED_BY_NAV,
    TimeTypeAus.LAST_MODIFIED_BY_NAV,
    TimeTypeAus.MDF_SYSTEM_RECORD_STATUS_NAV
  ];
  /**
   * All fields selector.
   */
