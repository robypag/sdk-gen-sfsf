...
var CandidateTags = /** @class */ (function (_super) {
    ...
    CandidateTags.builder = function () {
        return core_1.Entity.entityBuilder(CandidateTags);
    };
    /**
    ...
    CandidateTags.customField = function (fieldName) {
        return core_1.Entity.customFieldSelector(fieldName, CandidateTags);
    };
    /**
     ...
     */
    CandidateTags._defaultServicePath = 'VALUE_IS_UNDEFINED';
