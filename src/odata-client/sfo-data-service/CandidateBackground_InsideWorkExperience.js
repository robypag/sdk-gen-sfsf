...
var CandidateBackground_InsideWorkExperience = /** @class */ (function (_super) {
    ...
    CandidateBackground_InsideWorkExperience.builder = function () {
        return core_1.Entity.entityBuilder(CandidateBackground_InsideWorkExperience);
    };
    /**
    ...
    CandidateBackground_InsideWorkExperience.customField = function (fieldName) {
        return core_1.Entity.customFieldSelector(fieldName, CandidateBackground_InsideWorkExperience);
    };
    /**
     ...
     */
    CandidateBackground_InsideWorkExperience._defaultServicePath = 'VALUE_IS_UNDEFINED';
