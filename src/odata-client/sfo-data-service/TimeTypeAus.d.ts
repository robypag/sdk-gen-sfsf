...
export declare namespace TimeTypeAus {
     ...
     * Use to reference this property in query operations such as 'select' in the fluent request API.
     */
    const CREATED_BY_NAV: OneToOneLink<TimeTypeAus, User>;
    /**
     * Static representation of the one-to-one navigation property [[lastModifiedByNav]] for query construction.
     * Use to reference this property in query operations such as 'select' in the fluent request API.
     */
    const LAST_MODIFIED_BY_NAV: OneToOneLink<TimeTypeAus, User>;
    /**
     * Static representation of the one-to-one navigation property [[mdfSystemRecordStatusNav]] for query construction.
     * Use to reference this property in query operations such as 'select' in the fluent request API.
     */
    const MDF_SYSTEM_RECORD_STATUS_NAV: OneToOneLink<TimeTypeAus, MdfEnumValue>;
    /**
     * All fields of the TimeTypeAus entity.
     */
    const _allFields: Array<StringField<TimeTypeAus> | BooleanField<TimeTypeAus> | DateField<TimeTypeAus> | BigNumberField<TimeTypeAus> | OneToOneLink<TimeTypeAus, User> | OneToOneLink<TimeTypeAus, MdfEnumValue>>;
    /**
     * All fields selector.
     */
