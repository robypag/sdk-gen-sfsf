...
var JobApplicationSnapshot_InsideWorkExperience = /** @class */ (function (_super) {
    ...
    JobApplicationSnapshot_InsideWorkExperience.builder = function () {
        return core_1.Entity.entityBuilder(JobApplicationSnapshot_InsideWorkExperience);
    };
    /**
    ...
    JobApplicationSnapshot_InsideWorkExperience.customField = function (fieldName) {
        return core_1.Entity.customFieldSelector(fieldName, JobApplicationSnapshot_InsideWorkExperience);
    };
    /**
     ...
     */
    JobApplicationSnapshot_InsideWorkExperience._defaultServicePath = 'VALUE_IS_UNDEFINED';
...
(function (JobApplicationSnapshot_InsideWorkExperience) {
     ...
     * Use to reference this property in query operations such as 'select' in the fluent request API.
     */
    JobApplicationSnapshot_InsideWorkExperience.APPLICATION = new core_1.OneToOneLink('application', JobApplicationSnapshot_InsideWorkExperience, JobApplication_1.JobApplication);
    /**
