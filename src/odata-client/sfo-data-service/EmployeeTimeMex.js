...
var EmployeeTimeMex = /** @class */ (function (_super) {
     ...
     */
    EmployeeTimeMex._defaultServicePath = 'VALUE_IS_UNDEFINED';
...
(function (EmployeeTimeMex) {
     ...
     * Use to reference this property in query operations such as 'select' in the fluent request API.
     */
    EmployeeTimeMex.CREATED_BY_NAV = new core_1.OneToOneLink('createdByNav', EmployeeTimeMex, User_1.User);
    /**
     ...
     * Use to reference this property in query operations such as 'select' in the fluent request API.
     */
    EmployeeTimeMex.LAST_MODIFIED_BY_NAV = new core_1.OneToOneLink('lastModifiedByNav', EmployeeTimeMex, User_1.User);
    /**
     * Static representation of the one-to-one navigation property [[mdfSystemRecordStatusNav]] for query construction.
     * Use to reference this property in query operations such as 'select' in the fluent request API.
     */
    EmployeeTimeMex.MDF_SYSTEM_RECORD_STATUS_NAV = new core_1.OneToOneLink('mdfSystemRecordStatusNav', EmployeeTimeMex, MdfEnumValue_1.MdfEnumValue);
    /**
