 ...
 */
export class ExternalTimeRecordRequestBuilder extends RequestBuilder<ExternalTimeRecord> {
  /**
  ...
  getByKey(externalCode: string): GetByKeyRequestBuilder<ExternalTimeRecord> {
    return new GetByKeyRequestBuilder(ExternalTimeRecord, { externalCode: externalCode });
  }
  ...
  getAll(): GetAllRequestBuilder<ExternalTimeRecord> {
    return new GetAllRequestBuilder(ExternalTimeRecord);
  }
  ...
  create(entity: ExternalTimeRecord): CreateRequestBuilder<ExternalTimeRecord> {
    return new CreateRequestBuilder(ExternalTimeRecord, entity);
  }
  ...
  update(entity: ExternalTimeRecord): UpdateRequestBuilder<ExternalTimeRecord> {
    return new UpdateRequestBuilder(ExternalTimeRecord, entity);
  }
  ...
  delete(externalCodeOrEntity: any): DeleteRequestBuilder<ExternalTimeRecord> {
    return new DeleteRequestBuilder(ExternalTimeRecord, externalCodeOrEntity instanceof ExternalTimeRecord ? externalCodeOrEntity : { externalCode: externalCodeOrEntity! });
  }
}
