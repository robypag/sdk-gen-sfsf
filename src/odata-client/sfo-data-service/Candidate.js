...
var Candidate = /** @class */ (function (_super) {
    ...
    Candidate.builder = function () {
        return core_1.Entity.entityBuilder(Candidate);
    };
    /**
    ...
    Candidate.customField = function (fieldName) {
        return core_1.Entity.customFieldSelector(fieldName, Candidate);
    };
    /**
     ...
     */
    Candidate._defaultServicePath = 'VALUE_IS_UNDEFINED';
    return Candidate;
}(core_1.Entity));
...
(function (Candidate) {
     ...
     * Use to reference this property in query operations such as 'select' in the fluent request API.
     */
    Candidate.BUSINESS_PHONE = new core_1.StringField('businessPhone', Candidate, 'Edm.String');
    /**
     ...
     * Use to reference this property in query operations such as 'select' in the fluent request API.
     */
    Candidate.CONSENT_TO_MARKETING = new core_1.StringField('consentToMarketing', Candidate, 'Edm.String');
    /**
     ...
     * Use to reference this property in query operations such as 'select' in the fluent request API.
     */
    Candidate.CURRENT_COMPANY = new core_1.StringField('currentCompany', Candidate, 'Edm.String');
    /**
     ...
     * Use to reference this property in query operations such as 'select' in the fluent request API.
     */
    Candidate.ATTACHMENT_1 = new core_1.Link('attachment1', Candidate, Attachment_1.Attachment);
    /**
     * Static representation of the one-to-one navigation property [[candidateProfileConversionInfo]] for query construction.
     * Use to reference this property in query operations such as 'select' in the fluent request API.
     */
    Candidate.CANDIDATE_PROFILE_CONVERSION_INFO = new core_1.OneToOneLink('candidateProfileConversionInfo', Candidate, CandidateProfileConversionInfo_1.CandidateProfileConversionInfo);
    /**
     ...
     * Use to reference this property in query operations such as 'select' in the fluent request API.
     */
    Candidate.COMMENTS = new core_1.Link('comments', Candidate, CandidateComments_1.CandidateComments);
    /**
     * Static representation of the one-to-one navigation property [[coverLetter]] for query construction.
     * Use to reference this property in query operations such as 'select' in the fluent request API.
     */
    Candidate.COVER_LETTER = new core_1.OneToOneLink('coverLetter', Candidate, Attachment_1.Attachment);
    /**
     ...
     * Use to reference this property in query operations such as 'select' in the fluent request API.
     */
    Candidate.JOB_REQ_FWD_CANDIDATES = new core_1.Link('jobReqFwdCandidates', Candidate, JobReqFwdCandidates_1.JobReqFwdCandidates);
    /**
     * Static representation of the one-to-many navigation property [[jobsApplied]] for query construction.
     * Use to reference this property in query operations such as 'select' in the fluent request API.
     */
    Candidate.JOBS_APPLIED = new core_1.Link('jobsApplied', Candidate, JobApplication_1.JobApplication);
    /**
     ...
     * Use to reference this property in query operations such as 'select' in the fluent request API.
     */
    Candidate.MOBILITY = new core_1.Link('mobility', Candidate, CandidateBackground_Mobility_1.CandidateBackground_Mobility);
    /**
     ...
     * Use to reference this property in query operations such as 'select' in the fluent request API.
     */
    Candidate.RESUME = new core_1.OneToOneLink('resume', Candidate, Attachment_1.Attachment);
    /**
     * Static representation of the one-to-many navigation property [[state]] for query construction.
     * Use to reference this property in query operations such as 'select' in the fluent request API.
     */
    Candidate.STATE = new core_1.Link('state', Candidate, PicklistOption_1.PicklistOption);
    /**
     ...
     * Use to reference this property in query operations such as 'select' in the fluent request API.
     */
    Candidate.USER = new core_1.OneToOneLink('user', Candidate, User_1.User);
    /**
