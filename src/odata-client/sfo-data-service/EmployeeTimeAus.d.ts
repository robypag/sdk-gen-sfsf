...
export declare namespace EmployeeTimeAus {
     ...
     * Use to reference this property in query operations such as 'select' in the fluent request API.
     */
    const CREATED_BY_NAV: OneToOneLink<EmployeeTimeAus, User>;
    /**
     * Static representation of the one-to-one navigation property [[lastModifiedByNav]] for query construction.
     * Use to reference this property in query operations such as 'select' in the fluent request API.
     */
    const LAST_MODIFIED_BY_NAV: OneToOneLink<EmployeeTimeAus, User>;
    /**
     * Static representation of the one-to-one navigation property [[mdfSystemRecordStatusNav]] for query construction.
     * Use to reference this property in query operations such as 'select' in the fluent request API.
     */
    const MDF_SYSTEM_RECORD_STATUS_NAV: OneToOneLink<EmployeeTimeAus, MdfEnumValue>;
    /**
     * All fields of the EmployeeTimeAus entity.
     */
    const _allFields: Array<StringField<EmployeeTimeAus> | DateField<EmployeeTimeAus> | BigNumberField<EmployeeTimeAus> | BooleanField<EmployeeTimeAus> | OneToOneLink<EmployeeTimeAus, User> | OneToOneLink<EmployeeTimeAus, MdfEnumValue>>;
    /**
     * All fields selector.
     */
