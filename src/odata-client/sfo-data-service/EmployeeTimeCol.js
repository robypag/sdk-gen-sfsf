...
var EmployeeTimeCol = /** @class */ (function (_super) {
     ...
     */
    EmployeeTimeCol._defaultServicePath = 'VALUE_IS_UNDEFINED';
...
(function (EmployeeTimeCol) {
     ...
     * Use to reference this property in query operations such as 'select' in the fluent request API.
     */
    EmployeeTimeCol.CREATED_BY_NAV = new core_1.OneToOneLink('createdByNav', EmployeeTimeCol, User_1.User);
    /**
     ...
     * Use to reference this property in query operations such as 'select' in the fluent request API.
     */
    EmployeeTimeCol.LAST_MODIFIED_BY_NAV = new core_1.OneToOneLink('lastModifiedByNav', EmployeeTimeCol, User_1.User);
    /**
     * Static representation of the one-to-one navigation property [[mdfSystemRecordStatusNav]] for query construction.
     * Use to reference this property in query operations such as 'select' in the fluent request API.
     */
    EmployeeTimeCol.MDF_SYSTEM_RECORD_STATUS_NAV = new core_1.OneToOneLink('mdfSystemRecordStatusNav', EmployeeTimeCol, MdfEnumValue_1.MdfEnumValue);
    /**
