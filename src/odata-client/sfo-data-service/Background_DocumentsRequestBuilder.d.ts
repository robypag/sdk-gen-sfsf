 ...
 */
export declare class Background_DocumentsRequestBuilder extends RequestBuilder<Background_Documents> {
    /**
...
//# sourceMappingURL=Background_DocumentsRequestBuilder.d.ts.map