...
export declare namespace TimeAccountSnapshot {
     ...
     * Use to reference this property in query operations such as 'select' in the fluent request API.
     */
    const ACCOUNT_TYPE_NAV: OneToOneLink<TimeAccountSnapshot, TimeAccountType>;
    /**
     * Static representation of the one-to-one navigation property [[createdByNav]] for query construction.
     * Use to reference this property in query operations such as 'select' in the fluent request API.
     */
    const CREATED_BY_NAV: OneToOneLink<TimeAccountSnapshot, User>;
    /**
     * Static representation of the one-to-one navigation property [[lastModifiedByNav]] for query construction.
     * Use to reference this property in query operations such as 'select' in the fluent request API.
     */
    const LAST_MODIFIED_BY_NAV: OneToOneLink<TimeAccountSnapshot, User>;
    /**
     * Static representation of the one-to-one navigation property [[mdfSystemRecordStatusNav]] for query construction.
     * Use to reference this property in query operations such as 'select' in the fluent request API.
     */
    const MDF_SYSTEM_RECORD_STATUS_NAV: OneToOneLink<TimeAccountSnapshot, MdfEnumValue>;
    /**
     * Static representation of the one-to-one navigation property [[unitNav]] for query construction.
     * Use to reference this property in query operations such as 'select' in the fluent request API.
     */
    const UNIT_NAV: OneToOneLink<TimeAccountSnapshot, MdfEnumValue>;
    /**
     * Static representation of the one-to-one navigation property [[userIdNav]] for query construction.
     * Use to reference this property in query operations such as 'select' in the fluent request API.
     */
    const USER_ID_NAV: OneToOneLink<TimeAccountSnapshot, User>;
    /**
     * Static representation of the one-to-many navigation property [[wfRequestNav]] for query construction.
     * Use to reference this property in query operations such as 'select' in the fluent request API.
     */
    const WF_REQUEST_NAV: Link<TimeAccountSnapshot, WfRequest>;
    /**
     * All fields of the TimeAccountSnapshot entity.
     */
    const _allFields: Array<StringField<TimeAccountSnapshot> | BigNumberField<TimeAccountSnapshot> | BooleanField<TimeAccountSnapshot> | DateField<TimeAccountSnapshot> | OneToOneLink<TimeAccountSnapshot, TimeAccountType> | OneToOneLink<TimeAccountSnapshot, User> | OneToOneLink<TimeAccountSnapshot, MdfEnumValue> | Link<TimeAccountSnapshot, WfRequest>>;
    /**
     * All fields selector.
     */
