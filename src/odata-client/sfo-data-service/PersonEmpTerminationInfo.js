...
var PersonEmpTerminationInfo = /** @class */ (function (_super) {
    ...
    PersonEmpTerminationInfo.builder = function () {
        return core_1.Entity.entityBuilder(PersonEmpTerminationInfo);
    };
    /**
    ...
    PersonEmpTerminationInfo.customField = function (fieldName) {
        return core_1.Entity.customFieldSelector(fieldName, PersonEmpTerminationInfo);
    };
    /**
     ...
     */
    PersonEmpTerminationInfo._defaultServicePath = 'VALUE_IS_UNDEFINED';
...
(function (PersonEmpTerminationInfo) {
     ...
     */
    PersonEmpTerminationInfo.ACTIVE_EMPLOYMENTS_COUNT = new core_1.NumberField('activeEmploymentsCount', PersonEmpTerminationInfo, 'Edm.Int32');
    /**
     * Static representation of the [[latestTerminationDate]] property for query construction.
     * Use to reference this property in query operations such as 'select' in the fluent request API.
     */
    PersonEmpTerminationInfo.LATEST_TERMINATION_DATE = new core_1.DateField('latestTerminationDate', PersonEmpTerminationInfo, 'Edm.DateTime');
    /**
     * Static representation of the [[personIdExternal]] property for query construction.
     * Use to reference this property in query operations such as 'select' in the fluent request API.
     */
    PersonEmpTerminationInfo.PERSON_ID_EXTERNAL = new core_1.StringField('personIdExternal', PersonEmpTerminationInfo, 'Edm.String');
    /**
     ...
     * All fields selector.
     */
    PersonEmpTerminationInfo.ALL_FIELDS = new core_1.AllFields('*', PersonEmpTerminationInfo);
    /**
